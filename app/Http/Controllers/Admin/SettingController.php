...
class SettingController extends Controller {
	...
	public function  savesite_setting(Request $request){
		...
		$data = ['address' => $address, 'email' => $email, 'phone' => $phone, 'facebook' => $facebook, 'twitter' => $twitter, 'linkedin' => $linkedin, 'instagram' => $instagram, 'youtube' => $youtube, 'admin_percentage' => $adminshare, 'kilometer' => $radius];
