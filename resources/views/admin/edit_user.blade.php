            ...
            <div class="row">
                ...
                <div class="col-lg-6 mb-3">
                  <div class="card shadow rounded">
                     <div class="card-body">    
                        <form id="" action="{{url('admin/users/update')}}" method="post" enctype="multipart/form-data" >
                            @csrf
                            <div class="form-group mb-2">
                                <label class="fw-semibold  text-black">First Name</label>
                                <input type="text" class="form-control" name="fname"  id="fname" value="<?=@$result->first_name?>" required autocomplete="off">
                                <input type="hidden" class="form-control" name="id"  id="id" value="<?=@$result->id?>" >
                            </div>
							
							<div class="form-group mb-2">
                                <label class="fw-semibold  text-black">Last Name</label>
                                <input type="text" class="form-control" name="lname"  id="lname" value="<?=@$result->last_name?>" required autocomplete="off">
                            </div>
							
							<div class="form-group mb-2">
                                <label class="fw-semibold  text-black">Email</label>
                                <input type="email" class="form-control" name="email"  id="email" value="<?=@$result->email?>" required autocomplete="off">
                            </div>
                            <small id="email_error"></small>
							
							<div class="form-group mb-2">
                                <label class="fw-semibold  text-black">Phone</label>
                                <input type="text" class="form-control" name="phone"  id="phone" value="<?=@$result->phone?>" required autocomplete="off">
                            </div>
							...
							<div class="form-group mb-2">
								...
								<input type="text" class="form-control" name="address"  id="autocomplete" value="<?=@$result->address?>" required autocomplete="off">
							...
							<div class="mb-2 col-lg-12">
								...
								<input type="date" class="form-control" name="dob" id="dob" value="<?=@$dob?>" required autocomplete="off">
							...
							<div class="row">
								<div class="mb-2 col-lg-6">
									...
									<input type="text" class="form-control" name="country" id="country" value="<?=@$result->country?>" required autocomplete="off">
									<span id="error_country" class="text-danger"></span>
								</div> 
								
								<div class="mb-2 col-lg-6">
									<label class="fw-semibold  text-black">State</label>
									<input type="text" class="form-control" name="state" id="state" value="<?=@$result->state?>" required autocomplete="off">
									<span id="error_state" class="text-danger"></span>
								</div>
								
								<div class="mb-2 col-lg-6">
									<label class="fw-semibold  text-black">City</label>
									<input type="text" class="form-control" name="city" id="city" value="<?=@$result->city?>" required autocomplete="off">
									<span id="error_city" class="text-danger"></span>
								</div> 
								
								<div class="mb-2 col-lg-6">
									<label class="fw-semibold  text-black">Zip Code</label>
									<input type="text" class="form-control" name="pincode" id="pincode" value="<?=@$result->zipcode?>" required autocomplete="off">
							...
							<?php
								...
								if(!empty($result->area_interest)){
									$selected_tags = array();
									$explodearea_interest = explode(',', $result->area_interest);
                        ...
                        <div class="card-body">
							...
							<div class="container">
										...
										<div class="profile clearfix">                            
											...
											<div class="user clearfix">
												<div class="avatar item" id="item">
												    <?php
														if(!empty(@$result->profile_image) && file_exists('public/profile/'.@$result->profile_image.'')){
															$profilePic = url('profile/'.@$result->profile_image.'');
														}else{
															$profilePic = url('profile/unnamed.jpg');
														}
												    ?>
													<img src="<?= @$profilePic ?>" class="img-thumbnail img-profile" id="blah">
												</div>                                
												<h2><span id="f-name"><?=@$result->first_name; ?></span> <span id="l-name"><?=@$result->last_name; ?></span></h2>                                
                                ...
                                <div class="col-lg-12 mb-3">
									...
									<div class="mt-3"> <label class="tx-11 font-weight-bold mb-0 "><h6>Phone</h6></label><p class="text-muted" id="individual_phone"><?=@$result->phone; ?></p></div>
									
									
									<div class="d-flex align-items-center justify-content-between mb-2">
									<h6 class="card-title mb-0">Address</h6>
									</div>
									<p id="individual_address"><?=@$result->address; ?></p>
									
									<div class="mt-3"> <label class="tx-11 font-weight-bold mb-0 "><h6>Country</h6></label><p class="text-muted" id="individual_country"><?=@$result->country; ?></p></div>
									<div class="mt-3"> <label class="tx-11 font-weight-bold mb-0 "><h6>State</h6></label><p class="text-muted" id="individual_state"><?=@$result->state; ?></p></div>
									<div class="mt-3"> <label class="tx-11 font-weight-bold mb-0 "><h6>City</h6></label><p class="text-muted" id="individual_city"><?=@$result->city; ?></p></div>
									<div class="mt-3"> <label class="tx-11 font-weight-bold mb-0 "><h6>Zipcode</h6></label><p class="text-muted" id="individual_zipcode"><?=@$result->zipcode; ?></p></div>
