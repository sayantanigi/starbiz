                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12 mb-3">
                                            <div class="card rounded">
                                                <div class="card-body">
                                                <?php $user_type = DB::table('user_type')->where(['id' => @$result->user_type])->select('*')->orderBy('id', 'DESC')->first(); ?>
                                                    <div class="mt-3">
                                                        <label class="tx-11 font-weight-bold mb-0 ">
                                                            <h6>User Name</h6>
                                                        </label>
                                                        <p class="text-muted" id="game_name"><?=@$result->first_name?><?=@$result->last_name?></p>
                                                    </div>
                                                    <div class="mt-3">
                                                        <label class="tx-11 font-weight-bold mb-0 ">
                                                            <h6>Email</h6>
                                                        </label>
                                                        <p class="text-muted" id="game_description"><?=strip_tags(@$result->email); ?></p>
                                                    </div>
                                                    <div class="mt-3">
                                                        <label class="tx-11 font-weight-bold mb-0 ">
                                                            <h6>Phone</h6>
                                                        </label>
                                                        <p class="text-muted" id="game_description"><?=@$result->phone ?></p>
                                                    </div>
                                                    <div class="mt-3">
                                                        <label class="tx-11 font-weight-bold mb-0 ">
                                                            <h6>UserType</h6>
                                                        </label>
                                                        <p class="text-muted" id="game_name"><?=@$user_type->name; ?></p>
                                                    </div>
                                                    <div class="mt-3">
                                                        <label class="tx-11 font-weight-bold mb-0 ">
                                                            <h6>Address</h6>
                                                        </label>
                                                        <p class="text-muted" id="game_name"><?=@$result->address; ?></p>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <label class="tx-11 font-weight-bold mb-0 ">
                                                            ...
                                                            <p class="text-muted" id="game_description"><?=@$result->country; ?></p>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <label class="tx-11 font-weight-bold mb-0 ">
                                                                <h6>State</h6>
                                                            </label>
                                                            <p class="text-muted" id="game_description"><?=@$result->state; ?></p>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <label class="tx-11 font-weight-bold mb-0 ">
                                                                <h6>City</h6>
                                                            </label>
                                                            <p class="text-muted" id="game_description"><?=@$result->city; ?></p>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <label class="tx-11 font-weight-bold mb-0 ">
                                                                <h6>Zipcode</h6>
                                                            </label>
                                                            <p class="text-muted" id="game_description"><?=@$result->zipcode; ?></p>
                                                        </div>
                                                        <?php
                                                        $tagName1 = '';
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <p class="text-muted" id="game_description"><?= @$tagName1?></p>
                                                        </div>
                                                        <?php
												        $interestName1 = '';
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <p class="text-muted" id="game_description"><?= @$interestName1?></p>
                                                        </div>
                                                    </div>
                                                    <?php
                                                    if (@$result->bio) {
                                                    ...
                                                    <div class="mt-3">
                                                        ...
                                                        <p class="text-muted" id="game_name"><?=$bio; ?></p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-12 mb-3">
                                            <div class="card rounded">
                                                <div class="card-body">
                                                    <?php foreach (@$academics as $k => $v) { ?>
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <label class="tx-11 font-weight-bold mb-0 ">
                                                                <h6>School / College Name</h6>
                                                            </label>
                                                            <p class="text-muted" id="game_description"><?=@$v->school_name; ?></p>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <label class="tx-11 font-weight-bold mb-0 ">
                                                                <h6>Course Name</h6>
                                                            </label>
                                                            <p class="text-muted" id="game_description"><?=@$v->course_name; ?></p>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <label class="tx-11 font-weight-bold mb-0 ">
                                                                <h6>Class Rank</h6>
                                                            </label>
                                                            <p class="text-muted" id="game_description"><?=@$v->rank; ?></p>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <label class="tx-11 font-weight-bold mb-0 ">
                                                                <h6>Graduation Year</h6>
                                                            </label>
                                                            <p class="text-muted" id="game_description"><?=@$v->graduation_year; ?></p>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <label class="tx-11 font-weight-bold mb-0 ">
                                                                <h6>GPA</h6>
                                                            </label>
                                                            <p class="text-muted" id="game_description"><?=@$v->gpa; ?></p>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <label class="tx-11 font-weight-bold mb-0 ">
                                                                <h6>ACT / SAT Score</h6>
                                                            </label>
                                                            <p class="text-muted" id="game_description"><?=@$v->act_score; ?></p>
                                                        </div>
                                                    </div>
                                                    <?php
                                        ...
                                        <?php } ?>
                                        <?php $athletics = DB::table('athletics')->where(['user_id' => @$result->id])->select('*')->orderBy('id', 'DESC')->get(); ?>
                                            ...
                                            <div class="card rounded">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        ...
                                                        <p class="text-muted" id="game_description"><?=@$v->feet . "'" . @$v->inches . '"'; ?></p>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <label class="tx-11 font-weight-bold mb-0 ">
                                                            <h6>Weight</h6>
                                                        </label>
                                                        <p class="text-muted" id="game_description"><?=@$v->weight; ?></p>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <label class="tx-11 font-weight-bold mb-0 ">
                                                            <h6>Strength</h6>
                                                        </label>
                                                        <p class="text-muted" id="game_description"><?=@$v->strength; ?></p>
                                                    </div>
                                                </div>
                                                <?php } } ?>
                                                </div>
                                        ...
                                        <?php } ?>
                                        <?php $experience = DB::table('experience')->where(['user_id' => @$result->id])->select('*')->orderBy('id', 'DESC')->get(); ?>
                                                ...
                                                foreach (@$experience as $k => $v) { ?>
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            ...
                                                            <p class="text-muted" id="game_description"><?=@$v->club_name; ?></p>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <label class="tx-11 font-weight-bold mb-0 ">
                                                                <h6>Designation</h6>
                                                            </label>
                                                            <p class="text-muted" id="game_description"><?=@$v->designation; ?></p>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <label class="tx-11 font-weight-bold mb-0 ">
                                                                <h6>Start Date</h6>
                                                            </label>
                                                            <p class="text-muted" id="game_description"><?=@$v->start_date; ?></p>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <label class="tx-11 font-weight-bold mb-0 ">
                                                                <h6>End Date</h6>
                                                            </label>
                                                            <p class="text-muted" id="game_description"><?=@$v->end_date; ?></p>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <label class="tx-11 font-weight-bold mb-0 ">
                                                                <h6>Information</h6>
                                                            </label>
                                                            <p class="text-muted" id="game_description"><?=@$v->information; ?></p>
                                                        </div>
                                                    </div>
                                                    <?php
                                        ...
                                        <?php } ?>
                                        <?php $reference = DB::table('reference')->where(['user_id' => @$result->id])->select('*')->orderBy('id', 'DESC')->get(); ?>
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            ...
                                                            <p class="text-muted" id="game_description"><?=@$v->coach_name; ?></p>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <label class="tx-11 font-weight-bold mb-0 ">
                                                                <h6>Coach Email</h6>
                                                            </label>
                                                            <p class="text-muted" id="game_description"><?=@$v->coach_email; ?></p>
                                                        </div>
                                                    </div>
                                                    <?php
                                        ...
                                        <?php } ?>
                                        <?php $guardian = DB::table('guardian')->where(['user_id' => @$result->id])->select('*')->orderBy('id', 'DESC')->get(); ?>
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            ...
                                                            <p class="text-muted" id="game_description"><?=@$v->guardian_name; ?></p>
                                                        </div>
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <p class="text-muted" id="game_description"><?=@$v->guardian_email; ?></p>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <label class="tx-11 font-weight-bold mb-0 ">
                                                                <h6>Guardian Phone</h6>
                                                            </label>
                                                            <p class="text-muted" id="game_description"><?=@$v->guardian_phone; ?></p>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <label class="tx-11 font-weight-bold mb-0 ">
                                                                <h6>Guardian Relation</h6>
                                                            </label>
                                                            <p class="text-muted" id="game_description"><?=@$v->guardian_relation; ?></p>
                                                        </div>
                                                    </div>
                                                    <?php
                                                    if (count($guardian) > 1) {
                                        ...
                                        <?php $document = DB::table('user_document')->where(['user_id' => @$result->id])->select('*')->orderBy('id', 'DESC')->first(); ?>
                                        <?php if ($document) { ?>
                                        <h4>User Document</h4>
                                        <div class="col-lg-12 mb-3">
                                            <div class="card rounded">
                                                <div class="card-body">
                                                    <div class="mt-3">
                                                        ...
                                                        <p class="text-muted" id="game_name"><?=@$document->document_type?></p>
                                                    </div>
                                                    <div class="mt-3">
                                                        <label class="tx-11 font-weight-bold mb-0 ">
                                                            <h6>Document Number</h6>
                                                        </label>
                                                        <p class="text-muted" id="game_description"><?=@$document->document_number?></p>
                                                    </div>
                                                    <?php
                                                    if (!empty(@$document->document_photo)) {
                                                        ...
                                                        foreach ($docPhoto as $keyPhoto => $valuePhoto) {
                                                            ...
                                                            <div class="mt-3">
                                                                <label class="tx-11 font-weight-bold mb-0 "><h6>Document Photo</h6></label>
                                                                <p class="text-muted" id="game_name">
                                                                    <img src="<?= @$document_1 ?>" style="width: 20%;object-fit: cover;border: 4px solid #d4dbd0;">
                                                                </p>
                                                                <a href="<?= @$document_1 ?>" download><i class="fa fa-download"></i></a>
                                                            </div>
                                                            <?php } else {
                                                ...
                                                <div class="mt-3">
                                                    ...
                                                    <p class="text-muted" id="game_description"><?=@$dob_date?></p>
                                                </div>
                                            </div>
                                        </div>
                                        </div>
                                            ...
                                            <div class="card rounded">
                                                <div class="card-body">
                                                    ...
                                                    <div class="mt-3">
                                                        ...
                                                        <p class="text-muted" id="game_name"><?=@$userInfo->first_name?><?=@$userInfo->last_name?></p>
                                                    </div>
                                                    <div class="mt-3">
                                                        <label class="tx-11 font-weight-bold mb-0 ">
                                                            <h6>TransactionId</h6>
                                                        </label>
                                                        <p class="text-muted" id="game_description"><?=@$transaction->txn_id; ?></p>
                                                    </div>
                                                    <div class="mt-3">
                                                        <label class="tx-11 font-weight-bold mb-0 ">
                                                            <h6>Currency</h6>
                                                        </label>
                                                        <p class="text-muted" id="game_name"><?=@$transaction->currency; ?></p>
                                                    </div>
                                                    <div class="mt-3">
                                                        <label class="tx-11 font-weight-bold mb-0 ">
                                                            <h6>Amount</h6>
                                                        </label>
                                                        <p class="text-muted" id="game_description"><?=@$transaction->amount ?></p>
                                                    </div>
                                                    <div class="mt-3"> <label class="tx-11 font-weight-bold mb-0 ">
                                                            <h6>Plan</h6>
                                                        </label>
                                                        <p class="text-muted" id="game_name"><?=@$sub_plan->name; ?></p>
                                                    </div>
                                                    <?php
    ...
    $expiry_date = date('M d, Y', strtotime(@$transaction->expiry_date));
											...
											?>
                                                    <div class="mt-3"> <label class="tx-11 font-weight-bold mb-0 ">
                                                        ...
                                                        <p class="text-muted" id="game_name"><?=@$expiry_date; ?></p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
