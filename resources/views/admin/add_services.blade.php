                     ...
                     <div class="card-body">    
                        <form action="{{url('admin/services/save')}}" method="post" enctype="multipart/form-data" >
							...
							<div class="form-group mb-2">
                                ...
                                <input type="number" class="form-control" name="service_price"  id="service_price"  autocomplete="off" required >
                            </div>
							...
							<div class="form-group mb-2">
                                ...
                                <textarea type="text" class="form-control editor summermote" name="service_description"  id="service_description"  autocomplete="off"  required></textarea>
                            </div>
