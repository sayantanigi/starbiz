                                            ...
                                            <div class=" pt-3">
                                                ...
                                                <div class="row">
															...
															<div class="col-md-5">
																...
																<div class="profile clearfix" >                            
																	...
																	<div class="image item" id="teamCover-Img">
																		...
																		<img src="<?=!empty(@$result->backgroung_image) ? url('events/'.@$result->backgroung_image.'') : url('profile/bnr.jpg'); ?>" class="img-cover" style="width: 100%;object-fit: contain;background-color: #eee;height: auto;" id="blah2">
															...
															<div class="col-md-5">
																...
																<div class="profile clearfix" >                            
																	...
																	<div class="image item" id="teamCover-Img">
																		...
																		<img src="<?=!empty(@$result->front_image) ? url('events/'.@$result->front_image.'') : url('profile/bnr.jpg'); ?>" class="img-cover" style="width: 100%;object-fit: contain;background-color: #eee;height: auto;" id="blah1">
                                                    ...
                                                    <div class="mb-2 col-lg-12">
                                                        ...
                                                        <input type="text" class="form-control" name="event_name" id="event_name" value="<?=@$result->event_name?>" > 

														<input type="hidden" class="form-control" name="eventId"  id="eventId" value="<?=@$result->id?>">
													...
													<div class="mb-2 col-lg-12">
                                                        ...
                                                        <textarea class="form-control " name="event_description" id="event_description"><?=@$result->description?></textarea>
															    ...
															    if(!empty(@$cat)){
																	...
																	foreach(@$cat as $k => $v){
																		...
																		echo '
																			...
																			<option value="'.@$v->id.'" '.(!empty(@$result->category == @$v->id) ? 'selected' : '').'>'.@$v->name.'</option>
													...
													<?php
													    ...
													    if(!empty(@$result->end_date)){
														    ...
														    $end_date = strftime('%Y-%m-%d',strtotime(@$result->end_date));
													...
													<?php
													    ...
													    if(!empty(@$result->start_time)){
														     $start_time = strftime('%H:%M', strtotime(@$result->start_time));
														}else{
															$start_time = '';
														}
														
														if(!empty(@$result->end_time)){
														     $end_time = strftime('%H:%M', strtotime(@$result->end_time));
														}else{
															$end_time = '';
														} 
														...
														// if(!empty(@$result->end_date)){
														    // $end_time = strftime('%H:%M', strtotime(@$result->end_date));
														// }else{
															// $end_time = '';
														// }
                                                    ...
                                                    <div class="mb-2 col-lg-6">
                                                        ...
                                                        <input type="date" class="form-control" name="event_start_date" id="event_start_date" value="<?=@$start_date?>">		
													...
													<!--<div class="mb-2 col-lg-6">
                                                        ...
                                                        <input type="date" class="form-control" name="event_end_date" id="event_end_date" value="<?=@$end_date?>">		
													...
													<div class="mb-2 col-lg-6">
                                                        ...
                                                        <input type="time" class="form-control" name="event_start_time" id="event_start_time" value="<?=@$start_time?>">		
													...
													<div class="mb-2 col-lg-6">
                                                        ...
                                                        <input type="time" class="form-control" name="event_end_time" id="event_end_time" value="<?=@$end_time?>">		
													...
													<div class="mb-2 col-lg-6">
                                                        ...
                                                        <input type="number" class="form-control" name="event_phone" id="event_phone" value="<?=@$result->phone?>">		
													...
													<div class="mb-2 col-lg-6">
                                                        ...
                                                        <input type="email" class="form-control" name="event_email" id="event_email" value="<?=@$result->email?>">		
													...
													<div class="mb-2 col-lg-6">
                                                        ...
                                                        <input type="text" class="form-control" name="event_website" id="event_website" value="<?=@$result->website?>">		
												   ...
												   ?>
														...
														<div class="row">
															...
															<div class="mb-2 col-lg-4">
																...
																<input type="text" class="form-control" name="ticket_name[]" id="ticket_name" value="<?=@$v->ticket_name?>">
															...
															<div class="mb-2 col-lg-4">
																...
																<input type="text" class="form-control" name="ticket_price[]" id="ticket_price" value="<?=@$v->ticket_price?>">
															...
															<div class="mb-2 col-lg-4">
																...
																<input type="text" class="form-control" name="ticket_offer_price[]" id="ticket_offer_price" value="<?=@$v->ticket_offer_price?>">
															...
															<div class="mb-2 col-lg-12">
																...
																<textarea class="form-control editor summermote features" name="ticket_features[]" id="ticket_features"><?=@$v->feature?></textarea>
                                                ...
                                                <div class="row">
														...
														<div class="row">
														   ...
														   <div class="mb-2 col-lg-12">
																...
																<input type="text" class="form-control" name="event_location" id="event_location" value="<?=@$result->location?>">

																<input type="hidden" class="form-control" name="event_latitude" id="event_latitude" value="<?=@$result->latitude?>">

																<input type="hidden" class="form-control" name="event_longitude" id="event_longitude" value="<?=@$result->longitude?>">
														    ...
														    <div class="mb-2 col-lg-6">
																...
																<input type="text" class="form-control" name="event_country" id="event_country" value="<?=@$result->country?>">
														   ...
														   <div class="mb-2 col-lg-6">
																...
																<input type="text" class="form-control" name="event_state" id="event_state" value="<?=@$result->state?>">
														   ...
														   <div class="mb-2 col-lg-6">
																...
																<input type="text" class="form-control" name="event_city" id="event_city" value="<?=@$result->city?>">
														   ...
														   <div class="mb-2 col-lg-6">
																...
																<input type="text" class="form-control" name="event_zipcode" id="event_zipcode" value="<?=@$result->zipcode?>">
															    ...
															    if(!empty(@$image)){
																	...
																	foreach(@$image as $k => $v){
																		...
																		echo '
																			...
																			<div class="uploadedimg preview-show-'.@$v->id.'" id="preview'.@$v->id.'">

																			<img src="'.(!empty($v->image) ? url('events/'.$v->image.'') : '').'">

																			<a  href="javascript:void(0);" class="closeimg image-cancel1 removeImage" data-no="'.@$v->id.'"  id="img'.@$v->id.'"><i class="fa fa-times" style="color: black;"></i></a>
 ...
 $(document).ready(function(){
	...
	$('#first-next-button').click(function(){
		...
		if(error_event_name != '' || error_event_description != '' || error_event_category != '' || error_event_start_date != '' || error_event_start_time != '' || error_event_phone !='' || error_event_email !=''){
			...
			url: '<?php echo url('admin/event/update');?>',
	...
	$('#second-next-button').click(function(){
		...
		if(error_ticket_name != '' || error_ticket_price != '' || error_ticket_offer_price != '' || error_ticket_features != '' ){
			...
			return false;
				...
				url: '<?php echo url('admin/event/updateTicket');?>',
	...
	$('#third-next-button').click(function(){
		...
		if(error_event_location != '' || error_event_country != '' || error_event_state != '' || error_event_city != '' || error_event_zipcode != ''){
			...
			return false;
				...
				url: '<?php echo url('admin/event/updateLocation');?>',
	...
	$('#four-next-button').click(function(){
		...
		if(totalfiles == 0){
			...
			url: '<?php echo url('admin/event/updateEventImage');?>',
...
$(document).ready(function(e){
 ...
 $(document.body).on('click', '.removeImage' ,function(){ 
		...
		$.ajax({
			...
			url: "<?php echo url('admin/event/deleteGallery'); ?>",

			type: "POST",

			data: {

			    gId: item, "_token": "{{ csrf_token() }}"
