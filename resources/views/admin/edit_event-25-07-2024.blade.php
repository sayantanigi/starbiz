...
.closeimg {
                                ...
                                <form id="msform" action="" method="POST" enctype="multipart/form-data" >
                                    ...
                                    <ul id="progressbar">
                                        <li class="active " id="account">
                                            ...
                                            <strong>Backgroung Banner</strong></a>
                                        </li>
                                    ...
                                    <fieldset id="step_1" class="<?php echo !empty($profile) ? 'pro-Info' : 'pro-Info'; ?>">
                                        <div class="form-card">
                                            <div class=" pt-3">
                                                <h3 class="text-uppercase text-center h4 fw-bold mb-3">Backgroung Banner</h3>
                                                <div class="row">
 ...
 $(document).ready(function(){
	...
	$('#first-next-button').click(function(){
		...
		if(error_event_name != '' || error_event_description != '' || error_event_category != '' || error_event_start_date != '' || error_event_end_date != '' || error_event_start_time != '' || error_event_end_time !=''){
