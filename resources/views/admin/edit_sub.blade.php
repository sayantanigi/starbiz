...
<style>
small>p{color:red}p strong{font-weight:600!important;color:#000!important}.sa-confirm-button-container button{background-color:#146c43!important;border-color:#146c43!important}body{margin-top:20px}.profile{width:100%;position:relative;background:#fff;border:1px solid #d5d5d5;padding-bottom:5px;margin-bottom:20px}.profile .image{display:block;position:relative;z-index:1;overflow:hidden;text-align:center;border:5px solid #fff}.profile .user{position:relative;padding:0 5px 5px}.profile .user .avatar{position:absolute;left:20px;top:-85px;z-index:2}.profile .user h2{font-size:16px;line-height:20px;display:block;float:left;margin:4px 0 0 135px;font-weight:700}.profile .user .actions{float:right}.profile .user .actions .btn{margin-bottom:0}.profile .info{float:left;margin-left:20px}.img-profile{height:100px;width:100px}.img-cover{width:800px;height:300px}@media (max-width:768px){.btn-responsive{padding:2px 4px;font-size:80%;line-height:1;border-radius:3px}}@media (min-width:769px) and (max-width:992px){.btn-responsive{padding:4px 9px;font-size:90%;line-height:1.2}}
</style>
                                    ...
                                    <form id="formsAssignmentValidate" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group mb-2">
                                            ...
                                            <select class="form-control" name="plan" id="plan">
                                                <option value="1" <?=((@$result->plan == 1) ? 'selected' : '')?>>Free
                                                </option>
                                                <option value="2" <?=((@$result->plan == 2) ? 'selected' : '')?>>Paid
                                                </option>
                                            </select>
                                        </div>
                                        ...
                                        <div id="amount_type"
                                            style="display:<?=((@$result->plan == 2) ? 'block' : 'none')?>;">
                                            <div class="form-group mb-2">
                                                <label class="fw-semibold  text-black">Subscription Amount</label>
                                                <input type="text" class="form-control" name="amount" id="amount"
                                                    value="<?=@$result->amount?>" autocomplete="off">
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6">
                                                    <select class="form-control" name="type" id="type">
                                                        <option value="1" <?=((@$result->type == 1) ? 'selected' : '')?>>
                                                            Month</option>
                                                        <option value="2" <?=((@$result->type == 2) ? 'selected' : '')?>>
                                                            Year</option>
                                                    </select>
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group mt-3 mb-2">
                                            ...
                                            <a class="btn btn-danger waves-effect waves-light m-l-30"
                                            ...
                                            <div class="card rounded">
                                                <div class="card-body">
                                                    ...
                                                    <div class="mt-3"> <label class="tx-11 font-weight-bold mb-0 ">
                                                        ...
                                                        <p class="text-muted" id="package-name"><?=@$result->name?></p>
                                                    </div>

                                                    <div class="mt-3"> <label class="tx-11 font-weight-bold mb-0 ">
                                                            <h6>Subscription Description</h6>
                                                        </label>
                                                        <p class="text-muted" id="package-description">
                                                            <?=strip_tags(@$result->description)?></p>
                                                    </div>
    ...
    $plan = 'Paid';
									...
									?>
                                                    ...
                                                    <div class="mt-3"> <label class="tx-11 font-weight-bold mb-0 ">
                                                        ...
                                                        <p class="text-muted" id="package-type"><?=@$plan?></p>
                                                    </div>

                                                    <div class="mt-3" id="pac-amount"
                                                        style="display:<?=((@$result->plan == 2) ? 'block' : 'none')?>;">
                                                        <label class="tx-11 font-weight-bold mb-0 ">
                                                            <h6>Subscription Amount</h6>
                                                        </label>
                                                        <p class="text-muted" id="package-amount"><?=@$result->amount?>
                                                        </p>
                                                    </div>
    ...
    $status = 'Inactive';
										...
										?>
                                                    ...
                                                    <div class="mt-3"> <label class="tx-11 font-weight-bold mb-0 ">
                                                        ...
                                                        </label><br /><span class="text-muted"
                                                            id="package-duraction_1"><?=@$result->duration?></span>
                                                        <span class="text-muted"
                                                            id="package-duraction_2"><?=@$type?></span></div>

                                                    <div class="mt-3"> <label class="tx-11 font-weight-bold mb-0 ">
                                                            <h6>Status</h6>
                                                        </label>
                                                        <p class="text-muted" id="package-status"><?=@$status?></p>
                                                    </div>
