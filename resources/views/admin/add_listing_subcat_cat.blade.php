            ...
            <div class="row">
                ...
                <div class="col-lg-6 mb-3">
                  <div class="card shadow rounded">
                     <div class="card-body">    
                        <form action="{{url('admin/listing/save-subcategory-save')}}" method="post" enctype="multipart/form-data" >
                            @csrf
							...
							<div class="form-group mb-2">
                                ...
                                <input type="text" class="form-control" name="subcategorysub"  id="subcategorysub" required>
                            </div>
