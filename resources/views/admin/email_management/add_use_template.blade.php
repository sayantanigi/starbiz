                ...
                <div class="col-lg-6 mb-3">
                  <div class="card shadow rounded">
                     <div class="card-body">    
						...
						<form  action="<?= url('admin/mailer/save_use_template')?>" method="post" enctype="multipart/form-data" >
							@csrf
										...
										<?php
										    ...
										    if(@$users){
												foreach(@$users as $k => $v){
													echo '<option value="'.@$v->email.'" >'.@$v->email.'('.@$v->first_name.' '.@$v->last_name.')</option>';
												}
											}
										?>
									</select>
								...
								<div class="form-group mt-3 mb-2">
									<button class="btn btn-success text-uppercase px-5 shadow" name="sent" id="sent" value="send">Send</button>
