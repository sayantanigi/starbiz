               ...
               <div class="card custom-shadow rounded-lg border">
                  <div class="card-body">
                  	<div class="row">
						...
						<?php if(!empty($flag)){?>
							...
							<!--<div class="col-sm-2 text-end" style="padding-left: 54px;">
	                     	    <a href="<?= url('admin/mailer')?>" class="btn btn-success btn-sm"><i class="fa fa-plus"></i>&nbsp;Back to Mailer</a>
	                        </div>-->
						<?php } else{?>
							
							
							<!--<div class="col-sm-2 text-end" style="padding-left: 54px;">
	                     	    <a href="<?= url('admin/emailtemplate/create')?>" class="btn btn-success btn-sm"><i class="fa fa-plus"></i>&nbsp;Add Template</a>
	                        </div>-->
						<?php } ?>
                     ...
                     <div class="">
					    ...
					    <div class="row">
						<div class="col-sm-2">
							<div class="speaker-wrapper speaker-col" style="border: 1px solid #999f974f;padding: 5px 25px;">
								<div class="single-speaker">
								</div>
								<ul class="profilenav mt-4">
									<li <?=((@$submenu == 'composelist') ? 'style="color: #0d6efd !important;background-color: #ccdbff !important;padding: 4px 6px;border-radius: 4px;"' : '')?>><a href="<?=url('admin/mailer/new_compose_mail')?>" class="">Compose</a></li>
									<li <?=((@$submenu == 'existinglist') ? 'style="color: #0d6efd !important;background-color: #ccdbff !important;padding: 4px 6px;border-radius: 4px;"' : '')?>><a href="<?=url('admin/mailer/existing_template')?>" class="">Use Template</a></li>
									<li <?=((@$submenu == 'sendlist') ? 'style="color: #0d6efd !important;background-color: #ccdbff !important;padding: 4px 6px;border-radius: 4px;"' : '')?>><a href="<?=url('admin/mailer/list_send_mail')?>" class="">Sent</a></li>
									<li <?=((@$submenu == 'draftlist') ? 'style="color: #0d6efd !important;background-color: #ccdbff !important;padding: 4px 6px;border-radius: 4px;"' : '')?>><a href="<?=url('admin/mailer')?>" class="" >List of Drafts</a></li>
								</ul>
							</div>
						</div>
							...
							<table id="datatable" class="table table-bordered dt-responsive nowrap w-100">
									   ...
									   <?php if (is_array($result) || is_object($result)) { ?>
											<?php foreach ($result as $k => $v): ?>
												<tr>
													<td><?php echo !empty($i) ? $i : ''; ?></td>
													<?php
														if(@$v->type=='duplicate')
														{
															$subject='Duplicate '.$count++.'-'.$v->subject;
														}
														else{
															$subject=$v->subject;
														}
													...
													{
														$attach='<i class="fas fa-paperclip"></i> <a href="'.url('email/'.$v->attachment.'').'">'.$v->attachment.'</a>';
													}
													else{
														$attach='';
													}
													...
													<td>
														...
														echo  '<a class="btn btn-warning btn-sm" href="'.url("admin/add-use-template/".base64_encode($v->id)).'">
														<input type="radio">
														USE
														</a> ' ;
														}
														...
														?>
														<a href="<?=url('admin/mailer/add_use_template/?id='.base64_encode(@$v->id).'')?>" title="Use" style="background: #ffc107;padding: 4px 9px;color: black;font-weight: 700;border-radius: 7px;"><input type="radio"> USE</a>
														<?php } ?>
													</td>
