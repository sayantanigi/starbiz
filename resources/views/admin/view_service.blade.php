								...
								<div class="container">
									<div class="col-md-12">
										<div class="profile clearfix">
                                            <?php
											    $image1 = DB::table('services_image')->where(['service_id' => @$result->id])->select('*')->orderBy('id', 'ASC')->first();
										    ?>										
											<div class="image item" id="Cover-Image">
											    <img src="<?= ((!empty(@$image1->image) && file_exists('public/service/'.@$image1->image.'')) ? url('service/'.@$image1->image.'') : url('events/bnr.jpg')); ?>" class="img-cover">
											</div>                            
                                ...
                                <div class="col-lg-12 mb-3">
									<div class="card rounded">
										<div class="card-body">
											...
											<div class="mt-3"> <label class="tx-11 font-weight-bold mb-0 "><h6>Service Name</h6></label><p class="text-muted" id="game_name"><?=@$result->name?></p></div>
											...
											<div class="mt-3"> <label class="tx-11 font-weight-bold mb-0 "><h6>Listing Name</h6></label><p class="text-muted" id="game_name"><?=@$listing->business_name; ?></p></div>
												
											<div class="row">
												<div class="col-md-12">
													
													<label class="tx-11 font-weight-bold mb-0 "><h6>Price</h6></label><p class="text-muted" id="game_description"><?='$'.@$result->price; ?></p>
												</div>
												
												<div class="col-md-6">
													<label class="tx-11 font-weight-bold mb-0 "><h6>Special Price</h6></label><p class="text-muted" id="game_description"><?='$'.@$result->special_price; ?></p>
												</div>
								...
								<h4>Images</h4>
								 <div class="col-lg-12 mb-3">
									<div class="card rounded">
										...
										<?php
											$image = DB::table('services_image')->where(['service_id' => @$result->id])->select('*')->orderBy('id', 'ASC')->get();
										?>
