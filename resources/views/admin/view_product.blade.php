								...
								<div class="container">
									<div class="col-md-12">
										<div class="profile clearfix">
                                            <?php
											    $image1 = DB::table('product_image')->where(['product_id' => @$result->id])->select('*')->orderBy('id', 'ASC')->first();
										    ?>										
											<div class="image item" id="Cover-Image">
											    <img src="<?= ((!empty(@$image1->image) && file_exists('public/product/'.@$image1->image.'')) ? url('product/'.@$image1->image.'') : url('events/bnr.jpg')); ?>" class="img-cover" style="object-fit: contain;">
											</div>                            
                                ...
                                <div class="col-lg-12 mb-3">
									<div class="card rounded">
										<div class="card-body">
											...
											<div class="mt-3"> <label class="tx-11 font-weight-bold mb-0 "><h6>Product Name</h6></label><p class="text-muted" id="game_name"><?=@$result->name?></p></div>
											
											<?php
												$category = DB::table('product_category')->where(['id' => @$result->category])->select('*')->orderBy('id', 'DESC')->first();
											?>
											...
											<?php
												$listing = DB::table('listing')->where(['id' => @$result->listing_id])->select('*')->orderBy('id', 'DESC')->first();
											?>
											<div class="mt-3"> <label class="tx-11 font-weight-bold mb-0 "><h6>Business Name</h6></label><p class="text-muted" id="game_name"><?=@$listing->business_name?></p></div>
											
											<div class="mt-3"> <label class="tx-11 font-weight-bold mb-0 "><h6>Price</h6></label><p class="text-muted" id="game_name"><?='$'.@$result->price; ?></p></div>
											
											<!--<div class="mt-3"> <label class="tx-11 font-weight-bold mb-0 "><h6>Special Price</h6></label><p class="text-muted" id="game_name"><?='$'.@$result->special_price; ?></p></div>
											
											<div class="mt-3"> <label class="tx-11 font-weight-bold mb-0 "><h6>Quantity On Stock</h6></label><p class="text-muted" id="game_name"><?=@$result->quantity; ?></p></div>
											...
											?>
											<div class="mt-3"> <label class="tx-11 font-weight-bold mb-0 "><h6>Availability</h6></label><p class="text-muted" id="game_name"><?=@$availability; ?></p></div>-->
											...
											<div class="mt-3"> <label class="tx-11 font-weight-bold mb-0 "><h6>Status</h6></label><p class="text-muted" id="game_description"><?=$status ?></p></div>
											
											<div class="mt-3"> <label class="tx-11 font-weight-bold mb-0 "><h6>Created On</h6></label><p class="text-muted" id="game_description"><?=date('d M, Y', strtotime(@$result->created_at))?></p></div>
										...
										<div class="card-body">
											...
											<div class="row">
												<div class="eventphoto my-3 specific_preview">
													<?php
														$image = DB::table('product_image')->where(['product_id' => @$result->id])->select('*')->orderBy('id', 'ASC')->get();
													?>
