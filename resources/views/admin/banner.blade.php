											...
											<tr>
												...
												<?php
												    if(!empty(@$v->image) && file_exists('public/banner/'.@$v->image.'')){
														$banner = url('public/banner/'.@$v->image.'');
													}else{
														$banner = url('noimage.jpg');
													}
												?>
												<td><img src="<?=@$banner?>" style="width:40%"></td>
												<td><?=@$v->name?></td>
												<td>
												...
												<td>
												    <a href="<?= url('admin/banner/edit/'.$v->id) ?>" class="btn btn-outline-success btn-sm" data-toggle="tooltip" title="Edit">
