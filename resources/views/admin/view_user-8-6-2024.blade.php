								...
								<div class="col-lg-12 mb-3">
									<div class="card rounded">
										<div class="card-body">
											...
											<div class="mt-3"> <label class="tx-11 font-weight-bold mb-0 "><h6>Expiry Date</h6></label><p class="text-muted" id="game_name"><?=date('M d, Y', strtotime(@$transaction->expiry_date)) ?></p></div>
