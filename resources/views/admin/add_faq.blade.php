            ...
            <div class="row">
                ...
                <div class="col-lg-6 mb-3">
                  <div class="card shadow rounded">
                     <div class="card-body">    
                        <form action="{{url('admin/cms/save-faq')}}" method="post" enctype="multipart/form-data" >
						    @csrf
							...
							<div class="form-group mb-2">
                                ...
                                <textarea type="text" class="form-control editor summermote" name="answer"  id="answer"  autocomplete="off" required></textarea>
                            </div>
