                        ...
                        <div class="row">
                                ...
                                <div class="col-lg-12 mb-3">
									<div class="card rounded">
										<div class="card-body">
										    <?php
												$userInfo = DB::table('users')->where(['id' => @$result->user_id])->select('*')->orderBy('id', 'DESC')->first();
											?>
											...
											<div class="mt-3"> <label class="tx-11 font-weight-bold mb-0 "><h6>Email</h6></label><p class="text-muted" id="game_description"><?=strip_tags(@$userInfo->email); ?></p></div>
											
											
											
											<div class="mt-3"> <label class="tx-11 font-weight-bold mb-0 "><h6>Phone</h6></label><p class="text-muted" id="game_description"><?=@$userInfo->phone ?></p></div>
											...
											<div class="row">
												...
												<div class="mt-3"> <label class="tx-11 font-weight-bold mb-0 "><h6>Transaction Id</h6></label><p class="text-muted" id="game_name"><?=@$result->txn_id?></p></div>
											
											
												<div class="mt-3"> <label class="tx-11 font-weight-bold mb-0 "><h6>Order Id</h6></label><p class="text-muted" id="game_description"><?=@$result->order_id; ?></p></div>
												
												
												<div class="mt-3"> <label class="tx-11 font-weight-bold mb-0 "><h6>Currency</h6></label><p class="text-muted" id="game_name"><?=@$result->currency; ?></p></div>
												
												<div class="mt-3"> <label class="tx-11 font-weight-bold mb-0 "><h6>Paid Amount</h6></label><p class="text-muted" id="game_description"><?=@$result->amount ?></p></div>
								...
								<?php if(@$result->payment_type == 6){ ?>
									<h4>Order Info</h4>
									<div class="col-lg-12 mb-3">
										<div class="card rounded">
											<div class="card-body">
												<?php
												    $product_info = unserialize(@$result->product_info);
													
													if($product_info){
														foreach($product_info as $k => $v){
													?>
													<div class="mt-3"> <label class="tx-11 font-weight-bold mb-0 "><h6>Product Name</h6></label><p class="text-muted" id="game_description"><?=@$v['product_name'] ?></p></div>
                                                    <?php													
														}
													}
												?>
