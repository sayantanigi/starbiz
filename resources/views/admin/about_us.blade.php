...
<div id="page-wrapper">
	<div class="container-fluid">
		...
		<form action="{{url('admin/cms/saveabout')}}" method="POST" enctype="multipart/form-data" >
		    @csrf
			<div class="row">
				<div class="col-md-12">
					<div class="card">
						...
						<div class="row">
							<div class="col-sm-8">
								...
								<div class="form-group mb-2 files">
									...
									?>
									<img src="<?php echo !empty($aboutUs->image) ? url('setting/'.$aboutUs->image.'') : url('noimage.jpg'); ?>" style="width: 30%;display:<?=(@$fileType == 1) ? 'block' : 'none';?>" id="blahImg" >
									
									<video id="blahVideo" style="width: 30%;display:<?=(@$fileType == 2) ? 'block' : 'none';?>" controls><source src="<?php echo !empty($aboutUs->image) ? url('setting/'.$aboutUs->image.'') : url('noimage.jpg'); ?>"  ></video>
								</div><br/>
