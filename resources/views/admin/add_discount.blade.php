            ...
            <div class="row">
                ...
                <div class="col-lg-6 mb-3">
                  <div class="card shadow rounded">
                     <div class="card-body">    
                        <form action="{{url('admin/discount/save')}}" method="post" enctype="multipart/form-data" >
                             @csrf
                            <div class="form-group mb-2">
                                <label class="fw-semibold  text-black">Select Type</label>
                                <select class="form-control" name="type"  id="type" required>
                                    <option value="">Select Type</option>
                                    <option value="0">Discount In Amount</option>
                                    <option value="1">Discount In Percentage</option>
                                </select>
								<span id="type_error" class="text-danger"></span>
                            </div>
							
							<div class="form-group mb-2" style="display:none;" id="discountPer">
                                <label class="fw-semibold  text-black">Discount Percentage</label>
                                <input type="number" class="form-control" name="percentage"  id="percentage" autocomplete="off">
								<span id="discount_error" class="text-danger"></span>
                            </div>
							
							<div class="form-group mb-2" style="display:none;" id="amountcountPer">
							...
							<div class="form-group mb-2">
                                ...
                                <input type="text" class="form-control" name="promo_code"  id="promo_code"  autocomplete="off" required>
								<span id="promo_code_error" class="text-danger"></span>
                            </div>
							
							<div class="form-group mb-2">
                                <label class="fw-semibold  text-black">Expire On</label>
                                <input type="date" class="form-control" name="expire_on"  id="expire_on"  autocomplete="off" required>
                       ...
                       <div class="card-body">
                            <div class="row">
								 ...
								 <div class="col-lg-12 mb-3">
									...
									<div class="mt-3"> <label class="tx-11 font-weight-bold mb-0 "><h6>Type</h6></label><p class="text-muted" id="text_discount"></p></div>
									
									<div class="mt-3"> <label class="tx-11 font-weight-bold mb-0 "><h6>Coupon Code</h6></label><p class="text-muted" id="promocode"></p></div>
									
									<div class="mt-3"> <label class="tx-11 font-weight-bold mb-0 "><h6>Discount Percentage</h6></label><p class="text-muted" id="disper"></p></div>
