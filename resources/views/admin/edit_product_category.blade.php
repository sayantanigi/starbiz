            ...
            <div class="row">
                ...
                <div class="col-lg-6 mb-3">
                  <div class="card shadow rounded">
                     <div class="card-body">    
                        <form action="{{url('admin/product/category/update_category')}}" method="post" enctype="multipart/form-data" >
                            @csrf
                            ...
                            <div class="form-group mb-2">
                                ...
                                <input type="hidden" class="form-control" name="catId"  id="catId"  autocomplete="off"  value="<?=@$result->id?>">
                            </div>
							...
							<div class="form-group mb-2">
                                ...
                                <select class="form-control" name="pckstatus"  id="pckstatus" required>
                                    ...
                                    <option value="1" <?=(!empty(@$result->status == 1) ? 'selected' : '')?>>Active</option>
                                    <option value="0" <?=(!empty(@$result->status == 0) ? 'selected' : '')?>>Inactive</option>
                                </select>
                            </div>
                            ...
                            <div class="row">
								 ...
								 <div class="col-lg-12 mb-3">
									<div class="card rounded">
										<div class="card-body">
											<div class="mt-3"> <label class="tx-11 font-weight-bold mb-0 "><h6>Category Name</h6></label><p class="text-muted" id="package-name"><?=@$result->name?></p></div>
