                  	...
                  	<div class="row">
	                  	<div class="col-sm-10">
							 ...
							 <div class="col-sm-2 text-end" style="padding-left: 54px;">
								 <a href="<?=url('admin/interest/add')?>" class="btn btn-success btn-sm"><i class="fa fa-plus"></i>&nbsp;Add</a>
							 </div>
										...
										<?php foreach ($result as $key => $v): ?>
											<tr>
												...
												<td class="text-center">
														...
														<a href="<?=url('admin/interest/edit/'.@$v->id.'')?>" class="btn btn-outline-success btn-sm" data-toggle="tooltip" title="Edit">
   ...
   function dealDetail(dealId) {
	...
	function deleteDeals(dealId) 
	{
		swal({
			...
			if (isConfirm) {
				window.location.href = '<?= url('admin/interest/delete') ?>/'+dealId
			}
		});
	}
