            ...
            <div class="row">
                ...
                <div class="col-lg-6 mb-3">
                  <div class="card shadow rounded">
                     <div class="card-body">    
                        <form action="{{url('admin/listing/save-subcategory')}}" method="post" enctype="multipart/form-data" >
                            @csrf
								 ...
								 <div class="col-lg-12 mb-3">
									<div class="card rounded">
										<div class="card-body">
											...
											<div class="mt-3"> <label class="tx-11 font-weight-bold mb-0 "><h6>Subcategory Name</h6></label><p class="text-muted" id="subcategory-name"></p></div>
