...
<div id="page-wrapper">
	<div class="container-fluid">
		...
		<form action="{{url('admin/access-management/update')}}" method="POST" enctype="multipart/form-data" >
		    @csrf
			<div class="row">
				<div class="col-md-12">
					<div class="card">
							...
							<div class="col-sm-8">
							    ...
							    <div class="form-group mb-2">
									...
									<select class="form-control" name="user_type" id="user_type" required>
									    <option value="1111" <?=((@$result->role_id == 1111) ? 'selected' : '')?>>Admin</option>
									    <option value="0000" <?=((@$result->role_id == 0000) ? 'selected' : '')?>>Sub admin</option>
									</select>
								</div>
								<small id="user_type_error"></small>
								...
								<div class="form-group mb-2">
									...
									<input type="email" class="form-control" name="email"  id="email"  autocomplete="off"  required value="<?=@$result->email?>">
								</div>
								<small id="email_error"></small>
								
								<div class="form-group mb-2">
									<label class="fw-semibold  text-black">Password <small>(if you want to change password then enter the password.)</small></label>
