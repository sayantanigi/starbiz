            ...
            <div class="row">
                ...
                <div class="col-lg-6 mb-3">
                  <div class="card shadow rounded">
                     <div class="card-body">    
                        <form id="submitform" action="{{url('admin/update-user-type')}}" method="post" enctype="multipart/form-data" >
                             @csrf
                            ...
                            <div class="form-group mb-2">
                                ...
                                <input type="text" class="form-control" name="name"  id="name" value="<?=@$result->name?>" required autocomplete="off">
                            ...
                            <div class="row">
								 ...
								 <div class="col-lg-12 mb-3">
										<div class="card rounded">
											<div class="card-body">
												<div class="mt-3"> <label class="tx-11 font-weight-bold mb-0 "><h6>User Type</h6></label><p class="text-muted" id="first_name"><?=@$result->name?></p></div>
                                                 <?php
												     $status = '';
												     if(@$result->status == 1){
														 $status = 'Active';
