...
<div id="page-wrapper">
	<div class="container-fluid">
		...
		<form action="{{url('admin/listing/saveBulklisting')}}" method="POST" enctype="multipart/form-data" >
		    @csrf
			<div class="row">
				<div class="col-md-12">
					<div class="card">
                   <div class="card-body">
						...
						<div class="col-sm-6">
							<div class="form-group mb-2">
								<label class="fw-semibold  text-black">Choose CSV File</label>
								<input type="file" class="form-control" name="file"  id="file"  autocomplete="off" value="">
							</div>
							<small id="heading_error"></small>
							
							<div class="col-sm-6 col-sm-offset-2 mb-3" style="padding-left:0px;"><br/><br/>
