                     ...
                     <div class="card-body">    
                        <form action="{{url('admin/product/update')}}" method="post" enctype="multipart/form-data" >
                            ...
                            <div class="form-group mb-2">
                                ...
                                <input type="text" class="form-control" name="product_name"  id="product_name"  autocomplete="off" value="<?=@$result->name?>" required >
                            </div>
							...
							<div class="form-group mb-2">
                                ...
                                <input type="number" class="form-control" name="product_price"  id="product_price"  autocomplete="off" value="<?=@$result->price?>" required >
                            </div>
							
							<!--<div class="form-group mb-2">
                                <label class="fw-semibold  text-black">Special Price *</label>
                                <input type="number" class="form-control" name="product_special"  id="product_special"  value="<?=@$result->special_price?>" autocomplete="off" required >
                            </div>
							...
							<div class="form-group mb-2">
                                ...
                                <textarea type="text" class="form-control editor summermote" name="product_description"  id="product_description"  autocomplete="off"  required><?=@$result->description?></textarea>
                            </div>
							...
							<div class="form-group mb-2">
                                ...
                                <input type="hidden" class="form-control" name="product_id"  id="product_id"   value="<?=@$result->id?>">
                            </div>
							<?php
							    $image = DB::table('product_image')->where(['product_id' => @$result->id])->select('*')->orderBy('id', 'DESC')->get();
							?>
								    ...
								    if($image){
										foreach($image as $k => $v){
											...
											if(!empty(@$v->image) && file_exists('public/product/'.@$v->image.'')){
												$productImg = url('product/'.@$v->image.'');
											}else{
												$productImg = '';
											}
