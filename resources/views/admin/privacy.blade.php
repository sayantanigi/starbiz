...
<div id="page-wrapper">
	<div class="container-fluid">
		...
		<form action="{{url('admin/cms/update-privacy')}}" method="POST" enctype="multipart/form-data" id="">
		    @csrf
			<div class="row">
				<div class="col-md-12">
					<div class="card">
						...
						<div class="row">
							<div class="col-sm-8">
								...
								<div class="form-group mb-2">
									...
									<input type="text" class="form-control" name="heading"  id="heading1"  autocomplete="off" value="<?php echo !empty($result->heading) ? $result->heading : ''; ?>">
								</div>
...
$(document).ready(function(){
	$("#submitAboutus").on('submit', function(e){
		...
		$.ajax({
		type: 'POST',
		url: '<?php echo url('admin/cms/savePrivacy'); ?>',
		...
		success: function(data){
			...
			if(data.status == 1)
			{
              swal({title: "Sucess!", text: "<strong>"+data.message+"</strong>", type: "success", showConfirmButton: true, html:true}, function(){ window.location.href = "<?=url('admin/cms/privacy')?>"});
			}
