            ...
            <div class="row">
                ...
                <div class="col-lg-6 mb-3">
                  <div class="card shadow rounded">
                     <div class="card-body">    
                        <form action="{{url('admin/product/subcategory/update')}}" method="post" enctype="multipart/form-data" >
                            @csrf
                            ...
                            <div class="form-group mb-2">
								...
								<select class="form-control" name="category"  id="category" required>
									...
									<?php 
									    if(!empty(@$cat)){
											foreach(@$cat as $k => $v){
												echo '<option value="'.@$v->id.'" '.((@$v->id == @$result->category_id) ? 'selected' : '').'>'.@$v->name.'</option>';
											}
										}
									?>
