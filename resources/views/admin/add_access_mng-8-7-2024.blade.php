                  ...
                  <div class="card shadow rounded">
                     <div class="card-body">    
                        <form id="" action="{{url('admin/access-management/save')}}" method="post" enctype="multipart/form-data" >
							...
							<br/>
							<div class="form-group mb-2">
                                <label class="fw-semibold  text-black">Promotion &nbsp; <input type="checkbox" name="promotionMng" id="promotionMng" style="width:14px;height:14px;"></label>
							...
							<div class="form-group mb-2">
							    <div class="row">
									<div class="col-md-3">
										...
										<input type="checkbox" name="menu_id[]" value="14" id="interest" class="interestMng_menu" style="display:none;">
									</div>
