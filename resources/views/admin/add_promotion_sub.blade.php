            ...
            <div class="row">
                ...
                <div class="col-lg-8 mb-3">
                  <div class="card shadow rounded">
                     <div class="card-body">    
                        <form action="{{url('admin/promotion/plan/save')}}" method="post" enctype="multipart/form-data" >
                            @csrf
							...
							<div class="row">
							    <div class="col-lg-6">
									...
									<input type="text" class="form-control" name="discount"  id="discount"   autocomplete="off" value="0" >
								</div>
								
								<div class="col-lg-6">
									<label class="fw-semibold  text-black">Plan Duration *</label>
									<input type="text" class="form-control" name="plan_duration"  id="plan_duration"  placeholder="Number of Months"  autocomplete="off" required >
								</div>
							</div>
							...
							<div class="col-lg-12" style="display:none;" id="preferred_listing_price_block">
								<label class="fw-semibold  text-black">Extra Amount for Preferred Listing</label>
								<input type="text" class="form-control" name="preferred_listing_price"  id="preferred_listing_price"  autocomplete="off" >
							</div>
