                        ...
                        <form id="" action="{{url('admin/access-management/updateAccess')}}" method="post" enctype="multipart/form-data" >
							...
							<div class="container" style="margin: 0px 20px;">
								<div class="form-group mb-2">
									...
									<div class="row">
										...
										<div class="col-md-3"> 
											<label class="fw-semibold1  text-black"><input type="checkbox" name="view[]" class="user_type1 userMng_menu" value="1" <?=((in_array(5,$menuId)) ? 'checked' : '')?>> User type list</label>
											<input type="checkbox" name="menu_id[]" value="5" class="userMng_menu" id="user_type1" <?=((in_array(5,$menuId)) ? 'checked' : '')?> style="display:none;">
										</div>
										
										<div class="col-md-3">
											<label class="fw-semibold1  text-black"><input type="checkbox" name="created[]" class="user_type1 userMng_menu" value="1" <?=((in_array(5,$menuId)) ? 'checked' : '')?> > Add User type</label>
										</div>
										
										<div class="col-md-3">
											<label class="fw-semibold1  text-black"><input type="checkbox" name="edited[]" class="user_type1 userMng_menu" value="1" <?=((in_array(5,$menuId)) ? 'checked' : '')?>> Edit User type</label>
										</div>
										
										<div class="col-md-3">
											<label class="fw-semibold1  text-black"><input type="checkbox" name="deleted[]" class="user_type1 userMng_menu" value="1" <?=((in_array(5,$menuId)) ? 'checked' : '')?>> Delete User type</label>
										</div>
							...
							<div class="container" style="margin: 0px 20px;">
								<div class="form-group mb-2">
									...
									<div class="row">
										<div class="col-md-3"> 
											<label class="fw-semibold1  text-black"><input type="checkbox" name="view[]" class="users userMng_menu" value="1"  <?=((in_array(6,$menuId)) ? 'checked' : '')?>> User List</label>
											<input type="checkbox" name="menu_id[]" value="6" class="userMng_menu" id="users" <?=((in_array(6,$menuId)) ? 'checked' : '')?> style="display:none;">
										</div>
										
										<div class="col-md-3">
											<label class="fw-semibold1  text-black"><input type="checkbox" name="created[]" class="users userMng_menu" value="1" <?=((in_array(6,$menuId)) ? 'checked' : '')?>> Add User</label>
											
										</div>
										
										<div class="col-md-3">
											<label class="fw-semibold1  text-black"><input type="checkbox" name="edited[]" class="users userMng_menu" value="1" <?=((in_array(6,$menuId)) ? 'checked' : '')?>> Edit User</label>
										</div>
										
										<div class="col-md-3">
											<label class="fw-semibold1  text-black"><input type="checkbox" name="deleted[]" class="users userMng_menu" value="1" <?=((in_array(6,$menuId)) ? 'checked' : '')?>> Delete User</label>
										</div>
									</div>
								</div>
                            </div>
							...
							<div class="container" style="margin: 0px 20px;">
								<div class="form-group mb-2">
									...
									<div class="row">
										<div class="col-md-3"> 
											<label class="fw-semibold1  text-black"><input type="checkbox" name="view[]" class="event_category eventMng_menu" value="1" <?=((in_array(7,$menuId)) ? 'checked' : '')?>> Event Category list</label>
										...
										<div class="col-md-3">
											<label class="fw-semibold1  text-black"><input type="checkbox" name="created[]" class="event_category eventMng_menu" value="1" <?=((in_array(7,$menuId)) ? 'checked' : '')?>> Add Event Category</label>
										
										</div>
										
										<div class="col-md-3">
											<label class="fw-semibold1  text-black"><input type="checkbox" name="edited[]" class="event_category eventMng_menu" value="1" <?=((in_array(7,$menuId)) ? 'checked' : '')?>> Edit Event Category</label>
									
										</div>
										
										<div class="col-md-3">
											<label class="fw-semibold1  text-black"><input type="checkbox" name="deleted[]" class="event_category eventMng_menu" value="1" <?=((in_array(7,$menuId)) ? 'checked' : '')?>> Delete Event Category</label>
										</div>
									</div>
								</div>
                            </div>
							...
							<div class="container" style="margin: 0px 20px;">
								<div class="form-group mb-2">
									...
									<div class="row">
										<div class="col-md-3"> 
											<label class="fw-semibold1  text-black"><input type="checkbox" name="view[]" class="event eventMng_menu" value="1" <?=((in_array(8,$menuId)) ? 'checked' : '')?>> Event List</label>
											
											<input type="checkbox" name="menu_id[]" value="8" class="eventMng_menu" id="event" <?=((in_array(8,$menuId)) ? 'checked' : '')?> style="display:none;">
										</div>
										
										<div class="col-md-3">
											<label class="fw-semibold1  text-black"><input type="checkbox" name="created[]" class="event eventMng_menu" value="1" <?=((in_array(8,$menuId)) ? 'checked' : '')?>> Add Event</label>
										</div>
										
										<div class="col-md-3">
											<label class="fw-semibold1  text-black"><input type="checkbox" name="edited[]" class="event eventMng_menu" value="1" <?=((in_array(8,$menuId)) ? 'checked' : '')?>> Edit Event</label>
										</div>
										
										<div class="col-md-3">
											<label class="fw-semibold1  text-black"><input type="checkbox" name="deleted[]" class="event eventMng_menu" value="1" <?=((in_array(8,$menuId)) ? 'checked' : '')?>> Delete Event</label>
										</div>
									</div>
								</div>
                            </div>
							...
							<div class="container" style="margin: 0px 20px;">
								<div class="form-group mb-2">
									...
									<div class="row">
										<div class="col-md-3"> 
											<label class="fw-semibold1  text-black"><input type="checkbox" name="view[]" class="category listingMng_menu" value="1" <?=((in_array(9,$menuId)) ? 'checked' : '')?>> Listing Category List</label>
											
											<input type="checkbox" name="menu_id[]" value="9" class="listingMng_menu" id="category" <?=((in_array(9,$menuId)) ? 'checked' : '')?> style="display:none;">
										</div>
										
										<div class="col-md-3">
											<label class="fw-semibold1  text-black"><input type="checkbox" name="created[]" class="category listingMng_menu" value="1" <?=((in_array(9,$menuId)) ? 'checked' : '')?>> Add Listing Category</label>
										</div>
										
										<div class="col-md-3">
											<label class="fw-semibold1  text-black"><input type="checkbox" name="edited[]" class="category listingMng_menu" value="1" <?=((in_array(9,$menuId)) ? 'checked' : '')?>> Edit Listing Category</label>
										</div>
										
										<div class="col-md-3">
											<label class="fw-semibold1  text-black"><input type="checkbox" name="deleted[]" class="category listingMng_menu" value="1" <?=((in_array(9,$menuId)) ? 'checked' : '')?>> Delete Listing Category</label>
										</div>
									</div>
								</div>
                            </div>
							...
							<div class="container" style="margin: 0px 20px;">
								<div class="form-group mb-2">
									...
									<div class="row">
										<div class="col-md-3"> 
											<label class="fw-semibold1  text-black"><input type="checkbox" name="view[]" class="listing listingMng_menu" value="1" <?=((in_array(10,$menuId)) ? 'checked' : '')?>> Listing List</label>
											
											<input type="checkbox" name="menu_id[]" value="10" class="listingMng_menu" id="listing" <?=((in_array(10,$menuId)) ? 'checked' : '')?> style="display:none;">
										</div>
										
										<div class="col-md-3">
											<label class="fw-semibold1  text-black"><input type="checkbox" name="created[]" class="listing listingMng_menu" value="1" <?=((in_array(10,$menuId)) ? 'checked' : '')?>> Add Listing</label>
										</div>
										
										<div class="col-md-3">
											<label class="fw-semibold1  text-black"><input type="checkbox" name="edited[]" class="listing listingMng_menu" value="1" <?=((in_array(10,$menuId)) ? 'checked' : '')?>> Edit Listing</label>
										</div>
										
										<div class="col-md-3">
											<label class="fw-semibold1  text-black"><input type="checkbox" name="deleted[]" class="listing listingMng_menu" value="1" <?=((in_array(10,$menuId)) ? 'checked' : '')?>> Delete Listing</label>
										</div>
									</div>
								</div>
                            </div>
							...
							<div class="form-group mb-2">
							    <div class="row">
									<div class="col-md-3">
									    <label class="fw-semibold1  text-black"><input type="checkbox" name="view[]" class="discount discountMng_menu" value="1" <?=((in_array(11,$menuId)) ? 'checked' : '')?>> Discount List</label>
									...
									<div class="col-md-3">
									    <label class="fw-semibold1  text-black"><input type="checkbox" name="created[]" class="discount discountMng_menu" value="1" <?=((in_array(11,$menuId)) ? 'checked' : '')?>> Add Discount</label>
									</div>
									
									<div class="col-md-3">
									    <label class="fw-semibold1  text-black"><input type="checkbox" name="edited[]" class="discount discountMng_menu" value="1" <?=((in_array(11,$menuId)) ? 'checked' : '')?>> Edit Discount</label>
									</div>
									
									<div class="col-md-3">
									    <label class="fw-semibold1  text-black"><input type="checkbox" name="deleted[]" class="discount discountMng_menu" value="1" <?=((in_array(11,$menuId)) ? 'checked' : '')?>> Delete Discount</label>
									</div>
								</div>
                            </div>
							...
							<div class="form-group mb-2">
							    <div class="row">
									<div class="col-md-3">
									    <label class="fw-semibold1  text-black"><input type="checkbox" name="view[]"  class="subscription subscriptionMng_menu" value="1" <?=((in_array(12,$menuId)) ? 'checked' : '')?>> Subscription List</label>
									...
									<div class="col-md-3">
									    <label class="fw-semibold1  text-black"><input type="checkbox" name="created[]" class="subscription subscriptionMng_menu" value="1" <?=((in_array(12,$menuId)) ? 'checked' : '')?>> Add Subscription</label>
									</div>
									
									<div class="col-md-3">
									    <label class="fw-semibold1  text-black"><input type="checkbox" name="edited[]" class="subscription subscriptionMng_menu" value="1" <?=((in_array(12,$menuId)) ? 'checked' : '')?>> Edit Subscription</label>
									</div>
									
									<div class="col-md-3">
									    <label class="fw-semibold1  text-black"><input type="checkbox" name="deleted[]" class="subscription subscriptionMng_menu" value="1" <?=((in_array(12,$menuId)) ? 'checked' : '')?>> Delete Subscription</label>
									</div>
								</div>
                            </div>
							...
							<div class="container" style="margin: 0px 20px;">
								...
								<div class="form-group mb-2">
									<div class="row">
										<div class="col-md-3">
											<label class="fw-semibold1  text-black"><input type="checkbox" name="view[]"  class="promotion promotionMng_menu" value="1" <?=((in_array(13,$menuId)) ? 'checked' : '')?>> Promotion Ads List</label>
										...
										<div class="col-md-3">
											<label class="fw-semibold1  text-black"><input type="checkbox" name="created[]" class="promotion promotionMng_menu" value="1" <?=((in_array(13,$menuId)) ? 'checked' : '')?>> Add Promotion Ads</label>
										</div>
										
										<div class="col-md-3">
											<label class="fw-semibold1  text-black"><input type="checkbox" name="edited[]" class="promotion promotionMng_menu" value="1" <?=((in_array(13,$menuId)) ? 'checked' : '')?>> Edit Promotion Ads</label>
										</div>
										
										<div class="col-md-3">
											<label class="fw-semibold1  text-black"><input type="checkbox" name="deleted[]" class="promotion promotionMng_menu" value="1" <?=((in_array(13,$menuId)) ? 'checked' : '')?>> Delete Promotion Ads</label>
										</div>
									</div>
								</div>
                            </div>
							...
							<div class="container" style="margin: 0px 20px;">
								...
								<div class="form-group mb-2">
									<div class="row">
										<div class="col-md-3">
											<label class="fw-semibold1  text-black"><input type="checkbox" name="view[]"  class="promotion_cat promotionMng_menu" value="1" <?=((in_array(14,$menuId)) ? 'checked' : '')?>> Category List</label>
										...
										<div class="col-md-3">
											<label class="fw-semibold1  text-black"><input type="checkbox" name="created[]" class="promotion_cat promotionMng_menu" value="1" <?=((in_array(14,$menuId)) ? 'checked' : '')?>> Add Category</label>
										</div>
										
										<div class="col-md-3">
											<label class="fw-semibold1  text-black"><input type="checkbox" name="edited[]" class="promotion_cat promotionMng_menu" value="1" <?=((in_array(14,$menuId)) ? 'checked' : '')?>> Edit Category</label>
										</div>
										
										<div class="col-md-3">
											<label class="fw-semibold1  text-black"><input type="checkbox" name="deleted[]" class="promotion_cat promotionMng_menu" value="1" <?=((in_array(14,$menuId)) ? 'checked' : '')?>> Delete Category</label>
										</div>
									</div>
								</div>
                            </div>
							...
							<div class="container" style="margin: 0px 20px;">
								...
								<div class="form-group mb-2">
									<div class="row">
										<div class="col-md-3">
											<label class="fw-semibold1  text-black"><input type="checkbox" name="view[]"  class="promotion_plan promotionMng_menu" value="1" <?=((in_array(15,$menuId)) ? 'checked' : '')?>> Plan List</label>
										...
										<div class="col-md-3">
											<label class="fw-semibold1  text-black"><input type="checkbox" name="created[]" class="promotion_plan promotionMng_menu" value="1" <?=((in_array(15,$menuId)) ? 'checked' : '')?>> Add Plan</label>
										</div>
										
										<div class="col-md-3">
											<label class="fw-semibold1  text-black"><input type="checkbox" name="edited[]" class="promotion_plan promotionMng_menu" value="1" <?=((in_array(15,$menuId)) ? 'checked' : '')?>> Edit Plan</label>
										</div>
										
										<div class="col-md-3">
											<label class="fw-semibold1  text-black"><input type="checkbox" name="deleted[]" class="promotion_plan promotionMng_menu" value="1" <?=((in_array(15,$menuId)) ? 'checked' : '')?>> Delete Plan</label>
										</div>
									</div>
								</div>
                            </div>
							...
							<div class="form-group mb-2">
							    <div class="row">
									<div class="col-md-3">
									    <label class="fw-semibold1  text-black"><input type="checkbox" name="view[]"  class="interest interestMng_menu" value="1" <?=((in_array(16,$menuId)) ? 'checked' : '')?>> Invitation List</label>
									...
									<div class="col-md-3" style="display:none;">
									    <label class="fw-semibold1  text-black" ><input type="checkbox" name="created[]" class="interest interestMng_menu" value="1" <?=((in_array(16,$menuId)) ? 'checked' : '')?>> Add Invitation</label>
									</div>
									
									<div class="col-md-3" style="display:none;">
									    <label class="fw-semibold1  text-black" ><input type="checkbox" name="edited[]" class="interest interestMng_menu" value="1" <?=((in_array(16,$menuId)) ? 'checked' : '')?>> Edit Invitation</label>
									</div>
									
									<div class="col-md-3">
									    <label class="fw-semibold1  text-black"><input type="checkbox" name="deleted[]" class="interest interestMng_menu" value="1" <?=((in_array(16,$menuId)) ? 'checked' : '')?>> Delete Invitation</label>
									</div>
								</div>
                            </div>
							...
							<div class="form-group mb-2">
							    <div class="row">
									<div class="col-md-3">
									    <label class="fw-semibold1  text-black"><input type="checkbox" name="view[]"  class="transaction transactionMng_menu" value="1" <?=((in_array(17,$menuId)) ? 'checked' : '')?>> Transaction List</label>
									...
									<div class="col-md-3" style="display:none;">
									    <label class="fw-semibold1  text-black" ><input type="checkbox" name="created[]" class="transaction transactionMng_menu" value="1" <?=((in_array(17,$menuId)) ? 'checked' : '')?>> Add Transaction</label>
									</div>
									
									<div class="col-md-3" style="display:none;">
									    <label class="fw-semibold1  text-black" ><input type="checkbox" name="edited[]" class="transaction transactionMng_menu" value="1" <?=((in_array(17,$menuId)) ? 'checked' : '')?>> Edit Transaction</label>
									</div>
									
									<div class="col-md-3">
									    <label class="fw-semibold1  text-black"><input type="checkbox" name="deleted[]" class="transaction transactionMng_menu" value="1" <?=((in_array(17,$menuId)) ? 'checked' : '')?>> Delete Transaction</label>
									</div>
								</div>
                            </div>
							...
							<div class="form-group mb-2">
							    <div class="row">
									<div class="col-md-3">
									    <label class="fw-semibold1  text-black"><input type="checkbox" name="view[]"  class="tags tagsMng_menu" value="1" <?=((in_array(18,$menuId)) ? 'checked' : '')?>> Tags List</label>
										<input type="checkbox" name="menu_id[]" value="18" id="tags" class="tagsMng_menu" style="display:none;" <?=((in_array(18,$menuId)) ? 'checked' : '')?>>
									</div>
									
									<div class="col-md-3" >
									    <label class="fw-semibold1  text-black" ><input type="checkbox" name="created[]" class="tags tagsMng_menu" value="1" <?=((in_array(18,$menuId)) ? 'checked' : '')?>> Add Tags</label>
									</div>
									
									<div class="col-md-3" >
									    <label class="fw-semibold1  text-black" ><input type="checkbox" name="edited[]" class="tags tagsMng_menu" value="1"  <?=((in_array(18,$menuId)) ? 'checked' : '')?>> Edit Tags</label>
									</div>
									
									<div class="col-md-3">
									    <label class="fw-semibold1  text-black"><input type="checkbox" name="deleted[]" class="tags tagsMng_menu" value="1" <?=((in_array(18,$menuId)) ? 'checked' : '')?>> Delete Tags</label>
									</div>
								</div>
                            </div>
							...
							<div class="form-group mb-2">
							    <div class="row">
									<div class="col-md-3">
									    <label class="fw-semibold1  text-black"><input type="checkbox" name="view[]"  class="inte inteMng_menu" value="1" <?=((in_array(19,$menuId)) ? 'checked' : '')?>> Interest List</label>
										<input type="checkbox" name="menu_id[]" value="19" id="inte" class="inteMng_menu" style="display:none;" <?=((in_array(19,$menuId)) ? 'checked' : '')?>>
									</div>
									
									<div class="col-md-3" >
									    <label class="fw-semibold1  text-black" ><input type="checkbox" name="created[]" class="inte inteMng_menu" value="1" <?=((in_array(19,$menuId)) ? 'checked' : '')?>> Add Interest</label>
									</div>
									
									<div class="col-md-3" >
									    <label class="fw-semibold1  text-black" ><input type="checkbox" name="edited[]" class="inte inteMng_menu" value="1" <?=((in_array(19,$menuId)) ? 'checked' : '')?>> Edit Interest</label>
									</div>
									
									<div class="col-md-3">
									    <label class="fw-semibold1  text-black"><input type="checkbox" name="deleted[]" class="inte inteMng_menu" value="1" <?=((in_array(19,$menuId)) ? 'checked' : '')?>> Delete Interest</label>
									</div>
								</div>
                            </div>
