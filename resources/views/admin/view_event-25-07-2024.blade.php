									...
									<div class="col-md-12">
										<div class="profile clearfix">                            
											<div class="image item" id="Cover-Image">
											    <img src="<?= ((!empty(@$result->backgroung_image) && file_exists('public/events/'.@$result->backgroung_image.'')) ? url('events/'.@$result->backgroung_image.'') : url('events/bnr.jpg')); ?>" class="img-cover">
											</div>                            
                                ...
                                <div class="col-lg-12 mb-3">
									<div class="card rounded">
										<div class="card-body">
											...
											<div class="mt-3"> <label class="tx-11 font-weight-bold mb-0 "><h6>Start Date</h6></label><p class="text-muted" id="game_description"><?=date('M d, Y h:i A', strtotime(@$result->start_date));?></p></div>
											
											<div class="mt-3"> <label class="tx-11 font-weight-bold mb-0 "><h6>End Date</h6></label><p class="text-muted" id="game_description"><?=date('M d, Y h:i A', strtotime(@$result->end_date));?></p></div>
