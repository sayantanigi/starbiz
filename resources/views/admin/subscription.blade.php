                  	...
                  	<div class="row">
						...
						<?php if(@$planMenu_1->created == 1){ ?>
							<div class="col-sm-2 text-end" style="padding-left: 54px;">
							    <a href="<?=url('admin/subscription/add')?>" class="btn btn-success btn-sm"><i class="fa fa-plus"></i>&nbsp;Add</a>
							</div>
						<?php } ?>
											...
											<tr>
												...
												<td class="text-center">
												    <?php if(@$planMenu_1->edited == 1){ ?>
														<a href="<?=url('admin/subscription/edit/'.@$v->id.'')?>" class="btn btn-outline-success btn-sm" data-toggle="tooltip" title="Edit">
