                  ...
                  <div class="card-body">
                  	<div class="row">
	                     ...
	                     <div class="col-sm-2 text-end" style="padding-left: 54px;">
	                     	<a href="<?=url('admin/access-management/adduser')?>" class="btn btn-success btn-sm"><i class="fa fa-plus"></i>&nbsp;Add</a>
	                     </div>
	                  </div>   	
                     <div class="">
					    @if (session('status'))
										...
										<?php foreach ($result as $k => $v): ?>
											<tr>
												...
												<td class="text-center">
													<a href="<?= url('admin/access-management/edit/'.$v->id) ?>" class="btn btn-outline-success btn-sm" data-toggle="tooltip" title="Edit">
													    <i class="fas fa-edit"></i>
													</a>  
													<a href="<?= url('admin/access-management/edit-access/'.base64_encode($roleId)) ?>" class="btn btn-outline-success btn-sm" data-toggle="tooltip" title="Edit Access">
													    Edit Access
													</a>
													
													
												    <!--<a href="<?= url('admin/event/view/'.@$v->id) ?>" class="btn btn-outline-warning btn-sm" data-toggle="tooltip" title="View">
													    <i class="fa fa-eye"></i>
													</a>
...
var adminUrl = ""
   ...
   function dealDetail(dealId) {
	...
	function changeDealStatus(id, thisSwitch) {      
		...
		$.ajax({         
			url: '<?php echo url('admin/access-management/changestatus'); ?>',     
			type: 'POST',       
			dataType: 'json',       
			data: {         
				id: String(id),        
