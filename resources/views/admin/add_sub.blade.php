                        ...
                        <form  id="formsAssignmentValidate" method="post" enctype="multipart/form-data" >
							...
							<div class="form-group mb-2">
							    ...
							    <!--<ul style="list-style: none;">
								    <li><input type="checkbox" name="access[]" id="access" class="event_category" value="Business" style="width: 15px;height: 15px;"> &nbsp; <label class="fw-semibold1  text-black" style="font-weight: 400;">Business Management</label></li>
									
								    <li><input type="checkbox" name="access[]" id="access" class="event_category" value="Event" style="width: 15px;height: 15px;"> <label class="fw-semibold1  text-black" style="font-weight: 400;"> &nbsp; Event Management</label></li>
									
								    <li><input type="checkbox" name="access[]" id="access" class="event_category" value="Invitation" style="width: 15px;height: 15px;"> <label class="fw-semibold1  text-black" style="font-weight: 400;"> &nbsp; Invitation Management</label></li>
									
								    <li><input type="checkbox" name="access[]" id="access" class="event_category" value="Promotion" style="width: 15px;height: 15px;"> <label class="fw-semibold1  text-black" style="font-weight: 400;"> &nbsp; Promotion Management</label></li>
								</ul>-->
												...
												if(!empty($menus)){
													foreach ($menus as $key => $row){
														...
														<tr data-menu-id="<?=$row->id?>">
															<td><input type="checkbox" class="menu-checkbox" name="menu_check" id="menu_check_<?=$row->id?>"  relid="<?=$row->id?>"/></td>
															...
															<td>
																<input type="checkbox" name="has_read_access" relid-1="<?=$row->id?>" class="access-checkbox classMenu_<?=$row->id?>"/>
															</td>
															<td>
																<input type="checkbox" name="has_write_access" relid-1="<?=$row->id?>" class="access-checkbox classMenu_<?=$row->id?>"/>
															</td>
															<td>
																<input type="checkbox" name="has_full_access" relid-1="<?=$row->id?>" class="access-checkbox classMenu_<?=$row->id?>"/>
																
																<input type="text" name="number_count_<?=$row->id?>" relid-1="<?=$row->id?>" class="access-checkbox classMenu_<?=$row->id?> form-control_1" style="width: 50%;margin-left: 20px;color: #212529;background-color: #fff;background-clip: padding-box;border: 1px solid #ced4da;" value="0"/>
	...
	// $(document).ready(function() {
		...
		// $('#checkAll').change(function() {
			...
			// $(".menu-checkbox").change(function () {
				// var menuId = $(this).attr('relid');

				
				 
				 
				// if (this.checked) {
					// $(".classMenu_"+menuId+"").each(function() {
						// this.checked=true;
			...
			// $(".access-checkbox").change(function () {
				// var menuId = $(this).attr('relid-1');
				
				// if ($(".classMenu_"+menuId+"").is(":checked")) {
					// var isAllChecked = 0;
					...
					// });
						...
						// $("#menu_check_"+menuId+"").prop("checked", true);
					     
				// }else {
					// $("#menu_check_"+menuId+"").prop("checked", false);
				// }
		...
		$(document).ready(function() {
            ...
            $('#formsAssignmentValidate').on('submit', function(event) {
                ...
                $.ajax({
                    url: "<?=url('admin/subscription/save')?>",
                    method: "POST",
                    data: formData,
                    dataType: 'JSON',
