...
<body>
    ...
    <main role="main" class="Main">
        <div class="container-fluid m-0 Section ProfileTab">
            <!-- Edit Profile Modal -->
            <div class="modal fade CustomModal" id="EditProfileModal" data-bs-backdrop="static" data-bs-keyboard="false"
            ...
            <div class="row m-0 TabBar">
                <div class="TabBar">
                    <div class="Pagination">
                        <a href="<?=url('dashboard')?>" id="Home1"><i class="fa fa-angle-left" aria-hidden="true"></i>
                            Home / Profile</a>
                    </div>
                    <div class="row m-0" style="background: #fff;">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-12 UserDataContainer">
                            ...
                            <div class="ProfileBtnContainer">
                                <a href="javascript:void(0)" relid="<?=session()->get('USERLOGINID')?>"
                                    class="profileInfo" data-bs-toggle="modal" data-bs-target="#EditProfileModal">
                ...
                <div id="ProfileInfo" class="row m-0 TabContent active">
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        ...
                        <div class="ProfileDataBlock">
                            <p class="m-0 HeadingText">Tags</p>
                            <ul>
                                <?php
                                $tags = '';
                                if(@$userInfo->tags) {
                                    $exTags = explode(",", @$userInfo->tags);
                                    foreach ($exTags as $k => $v) {
                                        $tag = DB::table('tags')->where(['id' => @$v])->select('*')->first();
                                        $tags .= '<li>' . @$tag->name . '</li>';
                                    }
                                }
                                echo @$tags;
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="row g-3">
                        <div class="col-md-12 col-sm-12">
                            <input class="w-100" placeholder="What are you searching for?" id="search-box"
                                name="search">
                        </div>
                    </form>
                </div>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('#interest').chosen({ max_selected_options: 10, width: '100%' });
            $(".profileInfo").click(function () {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        $('#id').val(response.id);
                        $('#tags').chosen('destroy').val(response.tags).chosen();
                        $('#interest').chosen('destroy').val(response.interest).chosen();
                    }
                });
            });
        ...
        function changeAutoRenew(id, thisSwitch) {
            ...
            $.ajax({
                ...
                data: {
                    userId: String(id),
                    status: String(newStatus), "_token": "{{ csrf_token() }}"
                },
            })
                .done(function (data) {
                    if (data.status == 1) {
