...
<head>
  ...
  <style>
	...
	.onoffswitch-inner:before {
		content: "ON";
		padding-left: 10px;
		background-color: #c5a668; color: #FFFFFF;
	}
	...
	.onoffswitch-switch {
		display: block; width: 12px; margin: 10px;
		background: #FFFFFF;
		border: 2px solid #999999; border-radius: 20px;
  ...
  <header>
    ...
    <main role="main" class="Main">
     ...
     <div class="container-fluid m-0 Section ProfileTab" >
      ...
      <!-- Edit Password Modal -->
      <div class="modal fade CustomModal" id="EditPasswordModal" data-bs-backdrop="static" data-bs-keyboard="false"
        tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-xl">
          <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
              <form class="row g-3" id="change_pass_submitForm" method="POST" enctype="multipart/form-data">
                <div class="col-md-4 col-sm-12">
                  <label class="form-label">Old Password</label>
                  <input type="password" placeholder="Enter password" id="oldPassword" name="oldPassword" required>
                </div>
                <div class="col-md-4 col-sm-12">
                  <label class="form-label">New Password</label>
                  <input type="password" placeholder="Enter password" id="newPassword" name="newPassword" required>
                </div>
                <div class="col-md-4 col-sm-12">
                  <label class="form-label">Confirm Password</label>
                  <input type="password" placeholder="Enter password" id="confirmPassword" name="confirmPassword" required>
                </div>
