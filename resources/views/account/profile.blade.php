...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?=url('assets/home/style/style.css')?>">
    ...
    <style>
        .Tab,.Tab.active{border-radius:15px 15px 0 0;font-size:15px}.showSweetAlert>h2{font-size:20px!important}body{width:100vw;height:100vh;margin:0}.nav-categories .Active{background-color:rgb(255 255 255);box-shadow:0 10px 10px #f1f1f1}.nav-categories .Active p{color:#b38a41;font-weight:600}.TabContainer{display:flex;cursor:pointer;border-bottom:2px solid #8d6a30;padding:15px 20px 0;background:#fff}.TabContent,.onoffswitch-checkbox{display:none}.Tab{padding:10px 20px;background:#fff;color:#000;box-shadow:0 0 10px #ddd;min-width:150px;text-align:center}.Tab.active{color:#fff;background:linear-gradient(90deg,#b58b42,#7a5a28);font-weight:600}.TabContent{padding-left:10px;padding-right:10px}.TabContent.active{display:flex}.TabBar{position:sticky;top:-20px;z-index:100;padding-bottom:10px}.pac-container{z-index:10000!important}.onoffswitch{position:relative;width:60px;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none}.onoffswitch-label{display:block;overflow:hidden;cursor:pointer;border:2px solid #999;border-radius:20px}.onoffswitch-inner{display:block;width:200%;margin-left:-100%;-moz-transition:margin .3s ease-in;-webkit-transition:margin .3s ease-in;-o-transition:margin .3s ease-in;transition:margin .3s ease-in}.onoffswitch-inner:after,.onoffswitch-inner:before{display:block;float:left;width:50%;height:30px;padding:0;line-height:30px;font-size:14px;font-family:Trebuchet,Arial,sans-serif;font-weight:700;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;box-sizing:border-box}.onoffswitch-inner:before{content:"ON";padding-left:10px;background-color:#c5a668;color:#fff}.onoffswitch-inner:after{content:"OFF";padding-right:10px;background-color:#eee;color:#999;text-align:right}.onoffswitch-switch{display:block;width:12px;margin:10px;background:#fff;border:2px solid #999;border-radius:20px;position:absolute;top:0;bottom:0;right:31px;-moz-transition:.3s ease-in;-webkit-transition:.3s ease-in;-o-transition:.3s ease-in;transition:.3s ease-in}.onoffswitch-checkbox:checked+.onoffswitch-label .onoffswitch-inner{margin-left:0}.onoffswitch-checkbox:checked+.onoffswitch-label .onoffswitch-switch{right:0}
    </style>
</head>
<body>
    <nav class="sidebar">
    ...
    <main role="main" class="Main">
        <div class="container-fluid m-0 Section ProfileTab">
            <!-- Edit Profile Modal -->
            <div class="modal fade CustomModal" id="EditProfileModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-hidden="true">
                        ...
                        <div class="modal-body">
                            <form class="row g-3" id="submitForm" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="col-md-4 col-sm-12">
                                    ...
                                    <input type="hidden" placeholder="Enter location" name="latitude" id="latitude">
                                    <input type="hidden" placeholder="Enter location" name="longitude" id="longitude">
                                    <input type="hidden" placeholder="Enter location" name="country" id="country">
                                    <input type="hidden" placeholder="Enter location" name="state" id="state">
                                    <input type="hidden" placeholder="Enter location" name="city" id="city">
                                    <input type="hidden" placeholder="Enter location" name="zipcode" id="zipcode">
                                    <input type="hidden" placeholder="Enter location" name="id" id="id">
                                </div>
                                <div class="col-md-4 col-sm-12">
                                ...
                                <div class="col-md-4 col-sm-12">
                                    ...
                                    <input type="date" placeholder="dd/mm/yyyy" name="dob" id="dob">
                                </div>
                                <div class="col-md-4 col-sm-12">
                                    <label class="form-label">Interest</label>
                                    <select name="area_interest" id="area_interest" multiple>
                                ...
                                <div class="col-md-12 col-sm-12">
                                    ...
                                    <textarea type="text" placeholder="Description" name="bio" id="bio"></textarea>
                                </div>
            ...
            <!-- Edit Password Modal -->
            <div class="modal fade CustomModal" id="EditPasswordModal" data-bs-backdrop="static"
                ...
                <div class="modal-dialog modal-dialog-centered modal-xl">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form class="row g-3" id="change_pass_submitForm" method="POST"
                                enctype="multipart/form-data">
                                <div class="col-md-4 col-sm-12">
                                    <label class="form-label">Old Password</label>
                                    <input type="password" placeholder="Enter password" id="oldPassword"
                                        name="oldPassword" required>
                                </div>
                                <div class="col-md-4 col-sm-12">
                                    <label class="form-label">New Password</label>
                                    <input type="password" placeholder="Enter password" id="newPassword"
            ...
            <div class="row m-0 TabBar">
                <div class="TabBar">
                    <div class="Pagination">
                        <a href="<?=url('dashboard')?>" id="Home1"><i class="fa fa-angle-left" aria-hidden="true"></i>Home / Profile</a>
                    </div>
                    <div class="row m-0" style="background: #fff;">
                        <div class="col-lg-9 col-md-9 col-sm-12 UserProfileDataContainer">
                            ...
                            <div class="ProfileImageContainer">
                                ...
                                ?>
                                <img class="ProfileImage" src="<?=@$profile?>" alt="" id="preview_image">
                                <div class="ChangeImgBtnContainer">
                                    <input type="file" class="ImgInputField" id="profile_image" name="profile_image">
                                    <div class="ChangeImgBtnCover">
                                        <img src="<?=url('assets/home/images/Icon32.png')?>" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-3 col-sm-12 UserDataContainer">
                            ...
                            <div class="ProfileBtnContainer">
                                <a href="javascript:void(0)" relid="<?=session()->get('USERLOGINID')?>" class="profileInfo" data-bs-toggle="modal" data-bs-target="#EditProfileModal">
                                    <img class="ProfileBtnImg" src="<?=url('assets/home/images/Icon30.png')?>" alt="">
                                    <p class="m-0 ProfileBtnText">Edit Profile</p>
                                </a>
                                <a href="" data-bs-toggle="modal" data-bs-target="#EditPasswordModal">
                                    <img class="ProfileBtnImg" src="<?=url('assets/home/images/Icon31.png')?>" alt="">
                                    <p class="m-0 ProfileBtnText">Change Password</p>
                                </a>
                                <a href="javascript:void(0)">
                                    <div class="onoffswitch">
                                        <input type="checkbox" name="onoffswitch" class="onoffswitch-checkbox" id="myautorenew" value="" <?=((@$userInfo->auto_renew_status == 1) ? 'checked' : '')?> onchange="changeAutoRenew(<?=session()->get('USERLOGINID')?>, $(this))">
                                        <label class="onoffswitch-label" for="myautorenew">
                                            <span class="onoffswitch-inner"></span>
                                            <span class="onoffswitch-switch"></span>
                                        </label>
                                    </div>
                                    <p class="m-0 ProfileBtnText">Subscription Auto Renew</p>
                                </a>
                            </div>
                        </div>
                    </div>
                ...
                <div id="ProfileInfo" class="row m-0 TabContent active">
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        ...
                        <div class="ProfileDataBlock">
                            ...
                            <p class="m-0 SubHeadingText mb-1"><b>Address:</b> <?=@$userInfo->address?></p>
                            <p class="m-0 SubHeadingText mb-1"><b>Phone:</b> <?=@$userInfo->phone?></p>
                            <p class="m-0 SubHeadingText mb-1"><b>Email:</b> <?=@$userInfo->email?></p>
                            <?php
			                ...
			                ?>
                            <p class="m-0 SubHeadingText mb-1"><b>Birthday:</b> <?=@$dob?></p>
                        </div>
                        <div class="ProfileDataBlock">
                ...
                <div id="ProfilePhotos" class="row m-0 TabContent">
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <div class="EventPhotoContainer">
                            <?php
                            $myPhoto = DB::table('user_gallery_photo')->where(['user_id' => session()->get('USERLOGINID')])->select('*')->orderBy('id', 'DESC')->get();
                            if (count($myPhoto) > 0) {
                                foreach ($myPhoto as $k => $v) {
                                    if (!empty(@$v->image) && file_exists('public/photos/' . @$v->image . '')) {
                                        $photos = url('photos/' . @$v->image . '');
                                    } else {
                                        $photos = url('photos/noimage.jpg');
                                    }
                                    echo '<a href=""><img src="' . @$photos . '" alt=""></a>';
                                }
                            } ?>
                        </div>
                    </div>
    ...
    <script>
        ...
        $(document).ready(function () {
            $("#submitForm").on('submit', function (e) {
                ...
                var form_data = new FormData();
                //var profileImg = document.getElementById('inputGroupFile01').files[0];
                var totalfiles = document.getElementById('inputGroupFile01').files.length;
                for (var index = 0; index < totalfiles; index++) {
                    form_data.append("files[]", document.getElementById('inputGroupFile01').files[index]);
                }
                var fname = $('#fname').val();
                var lname = $('#lname').val();
                ...
                form_data.append("area_interest", area_interest);
                ...
                $.ajax({
                    ...
                    type: 'POST',
                    url: '<?php echo url('dashboard/updateProdule'); ?>',
                    data: form_data,
                    dataType: "json",
                    contentType: false,
                    cache: false,
                    ...
                    success: function (data) {
                        if (data.status == 1) {
                            swal({ title: "Sucess!", text: "<strong>" + data.msg + "</strong>", type: "success", showConfirmButton: true, html: true }, function () { window.location.href = "<?=url('dashboard/profile')?>" });
                        }
                        if (data.status == 0) {
                            //swal({title: "Fail!", text: "<strong>"+data.msg+"</strong>", type: "error", showConfirmButton: true, html:true}, function(){ window.location.href = "<?=url('dashboard/profile')?>"});
                        }
                    }
                });
            });
            ...
            $(".profileInfo").click(function () {
                ...
                $.ajax({
                    url: "<?=url('dashboard/get_profile_info')?>",
                    method: "POST",
                    ...
                    success: function (response) {
                        ...
                        $('#id').val(response.id);
                        $('#area_interest').chosen('destroy').val(response.interest).chosen();
                    }
                });
            });
            $("#change_pass_submitForm").on('submit', function (e) {
                e.preventDefault();
                //var form_data = new FormData();
                var form_data = new FormData();
                ...
                $.ajax({
                    ...
                    type: 'POST',
                    url: '<?php echo url('dashboard/updatePassword'); ?>',
                    data: form_data,
                    dataType: "json",
                    contentType: false,
                    cache: false,
                    ...
                    success: function (data) {
                        ...
                        if (data.status == 0) {
                            swal({ title: "Fail!", text: "<strong>" + data.error + "</strong>", type: "error", showConfirmButton: true, html: true });
                        }
                    }
                });
            });
            $(document).on("change", "#profile_image", function (e) {
                var profileImg = document.getElementById('profile_image').files[0];
                var fileType = profileImg.type;
                ...
                if ((fileType == match[0]) || (fileType == match[1]) || (fileType == match[2]) || (fileType == match[3]) || (fileType == match[4])) {
                    ...
                    document.getElementById("preview_image").src = blobURL;
                    var form_data = new FormData();
                    var totalfiles = document.getElementById('profile_image').files.length;
                    for (var index = 0; index < totalfiles; index++) {
                        form_data.append("profileImage", document.getElementById('profile_image').files[index]);
                    }
                    $.ajax({
                        headers: {
                            'X-CSRF-TOKEN': "{{ csrf_token() }}"
                        ...
                        type: 'POST',
                        url: '<?php echo url('dashboard/updateProfile'); ?>',
                        data: form_data,
                        dataType: "json",
                        contentType: false,
                        processData: false,
                    ...
                    swal({ title: "Fail!", text: "<strong>File format not supported.Supported format only jpeg|png|jpg</strong>", type: "error", showConfirmButton: true, html: true });
                }
            });
        });
        $(document).ready(function () {
    ...
    <script>
        ...
        function changeAutoRenew(id, thisSwitch) {
            ...
            $.ajax({
                url: '<?php echo url('dashboard/cancelSubscription'); ?>',
                type: 'POST',
                dataType: 'json',
                data: {
                    userId: String(id),
