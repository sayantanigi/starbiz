...
<main role="main" class="Main">
    ...
    <div class="container-fluid m-0 Section Promotion" style="display: none;">
        ...
        <?php } ?>
        <!-- Add Promotion Modal -->
        <div class="modal fade CustomModal" id="select-promotion-model" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-hidden="true">
            ...
            if (@$myeventList) {
				...
				<div class="Card col-lg-3 col-md-3 col-sm-6">
				  <div class="CardInner event-detail-1"   style="background:url(' . @$galleryImg . ') no-repeat center center / cover;" relid="' . @$v->id . '" data-bs-toggle="modal" data-bs-target="#DetailsMyEventModal">
					...
					<p class="SubHeading">Time: ' . @$start_time . '</p>
					<div class="IconContainer">
						<a href="javascript:void(0);" class="bookmarkEvent" id="bookmarkEvent1_' . @$v->id . '" relid="' . @$v->id . '">
						    ' . @$fav . '
						</a>
						' . $edit . '
						' . $delete . '
                    ...
                    <div class="modal-header">
                        ...
                        <div style="margin-left: 43rem;display:none;" id="productButton">
                            <button type="button" id="addProductUnderBusiness"
                                style="border: 1px solid #b58b42;border-radius: 5px;font-size: 14px;background: #c5a668;color: #fff;">Add
                                Product</button>
            ...
            <div class="row m-0 mt-3">
                ...
                if (count(@$plan)) {
                    ...
                    foreach (@$plan as $k => $v) {
                        ...
                        echo '
                        <div class="col-lg-3 col-md-3"> <div class="SubscriptionBlock">
                            <div class="SubscriptionHeadingBlock">
                                <h2>' . @$v->name . '</h2>
                                <p class="m-0">$ ' . @$v->amount . '/' . @$v->duration . '-' . @$type . '</p>
                            </div>
                            <ul> ' . @$out . ' </ul> <div class="m-0 row w-100 LearnMoreData" data-content="' . @$i . '"> ' . @$learnMore . ' </div> <div class="SubscriptionBtnContainer"> ' . @$sub . ' <!--<a href="" class="LearnMoreBtn" data-target="' . @$i . '">Learn More</a>--> </div> </div> </div>';
                        $i++;
                    }
                }
                ?>
