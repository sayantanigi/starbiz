																	...
																	<div class="panel-body">
																		...
																		<div class="row">
																			...
																			<div class="col-md-12">
																				...
																				<form action="{{url('dashboard/product_stripe_payment')}}" method="POST" id="paymentFrm">
																				    @csrf
																					<div class="row">
																						<div class="col-xs-12">
...
<script>
    var stripe = Stripe('<?='pk_test_51MPhgSIuZrwn6gWggTu5pxq41l6ZODzSg2zZ1kjKynv3yR61OZDey3AcNm2iwioDVJqSuJ3TCXJCdOAJn1VaNfyk00QkWY7DPT';?>');
