...
if (@$networkMng->read_access == 1 || @$networkMng->write_access == 1 || @$networkMng->full_access == 1) {
    ...
    <div class="container-fluid m-0 Section Promotion" style="display: none;">
        ...
        <?php } ?>
        <!-- Add Promotion Modal -->
        <div class="modal fade CustomModal" id="select-promotion-model" data-bs-backdrop="static"
                    ...
                    <div class="modal-body">
                        <form class="row g-3" id="adsSub" method="post" enctype="multipart/form-data">
                            ...
                            <div class="col-md-6 col-sm-12" style="display:none;" id="promotionPrefered">
                                ...
                                <input type="text" placeholder="Enter Duration Number of Days" name="duration"
...
if (count(@$adsPlan) > 0) {
    ...
    echo '<div class="col-md-12 col-sm-12 text-center">No Subscription Plan Available</div>';
}
                                    ?>
                                </div>
                            </div>
    ...
    foreach ($category as $k => $v) {
        echo '<option value="' . @$v->id . '">' . @$v->name . '</option>';
                            ...
                            <div class="col-md-4 col-sm-12">
                                ...
                                <input type="text" placeholder="Enter title" name="ads_name" id="ads_name"
                            ...
                            <div class="row m-0 pt-4 pb-2">
                                <div class="row m-0 InnerData g-3">
                                    ...
                                    <div class="col-md-6 col-sm-12">
                                        ...
                                        <select name="age" id="age" required multiple data-placeholder="Select Age">
    ...
    foreach (@$income as $k => $v) {
        echo '<option value="' . @$v->id . '">' . @$v->income . '</option>';
                                    ...
                                    <div class="col-md-4 col-sm-12">
                                        ...
                                        <input type="text" class="form-control" name="location" id="autocomplete_1"
...
if ($category) {
    foreach ($category as $k => $v) {
        echo '<option value="' . @$v->id . '">' . @$v->name . '</option>';
                            ...
                            <div class="col-md-4 col-sm-12">
                                <label class="form-label">Title</label>
                                <input type="text" placeholder="Enter title" name="edit_ads_name" id="edit_ads_name"
                                    autocomplete="off" required>
                            </div>
                            <div class="col-md-4 col-sm-12">
                                <label class="form-label">Upload File</label>
                                <input type="file" class="form-control" name="edit_ads_image" id="edit_ads_image">
                                <img src="" id="edit_image" style="width: 100px; margin-top: 10px;">
                            </div>
                            <div class="row m-0 pt-4 pb-2">
                                <div class="row m-0 InnerData g-3">
                                    <p class="Heading">Target Audience</p>
                                    ...
                                    <div class="col-md-6 col-sm-12">
                                        <label class="form-label">Age</label>
                                        <select name="edit_age" id="edit_age" required multiple
        ...
        echo '<option value="' . @$v->id . '">' . @$v->income . '</option>';
                                    ...
                                    <div class="col-md-4 col-sm-12">
                                        ...
                                        <input type="text" class="form-control" name="edit_location"
                                            id="edit_autocomplete_1" placeholder="Select location">
                                        <input type="hidden" class="form-control" name="edit_latitude"
                                            id="edit_latitude">
                                        <input type="hidden" class="form-control" name="edit_longitude"
                                            id="edit_longitude">
    ...
    if (@$adsList) {
        foreach (@$adsList as $k => $v) {
            if (!empty(@$v->image) && file_exists('public/ads/' . @$v->image . '')) {
                $imageUrl = url('ads/' . @$v->image . '');
            } else {
                $imageUrl = url('noimage.jpg');
            }
            echo '<div class="Card col-lg-3 col-md-3 col-sm-6">
								<div class="CardInner promotion-detail" style="background:url(' . @$imageUrl . ') no-repeat center center / cover;" relid="' . @$v->id . '"  data-bs-toggle="modal" data-bs-target="#DetailsPromotionModal">
								<div class="Cover"></div>
...
if (@$myadsList) {
    foreach (@$myadsList as $k => $v) {
        if (@$proMng->write_access == 1 || @$proMng->full_access) {
            $editDelete = '
						<a href="javascript::void(0);" class="edit-info" relid="' . $v->id . '" data-bs-toggle="modal" data-bs-target="#EditPromotionModal">
							<i class="fa fa-pencil-square" aria-hidden="true"></i>
						</a>
						<a href="javascript::void(0);" onclick="deletePromotion(' . @$v->id . ')" data-bs-toggle="modal" data-bs-target="#DeletePromotionModal1">
        ...
        echo '
				<div class="Card col-lg-3 col-md-3 col-sm-6">
					<div class="CardInner promotion-detail-1"  style="background:url(' . @$imageUrl . ') no-repeat center center / cover;" relid="' . @$v->id . '" data-bs-toggle="modal" data-bs-target="#DetailsPromotionModal">
						<div class="Cover"></div>
						<p class="Heading">' . @$v->ads_name . '</p>
						<p class="SubHeading">' . strip_tags(@$v->description) . '</p>
...
if (count(@$upcomingEventList)) {
    foreach (@$upcomingEventList as $k => $v) {
        echo '<option value="' . @$v->id . '">' . @$v->event_name . '</option>';
                            ...
                            <div class="col-md-4 col-sm-12">
                                <label class="form-label">Select A&E Member</label>
...
if (count(@$athletic)) {
    foreach (@$athletic as $k => $v) {
        echo '<option value="' . @$v->id . '">' . @$v->first_name . ' ' . @$v->last_name . '</option>';
                            ...
                            <div class="col-md-4 col-sm-12">
                                ...
                                <input type="time" placeholder="Time" name="invi_start_time" id="invi_start_time"
                                    required>
                            </div>
                            <div class="col-md-4 col-sm-12">
                            ...
                            <div class="col-md-12 col-sm-12">
                                ...
                                <textarea type="text" placeholder="Description" name="invi_description"
                                    id="invi_description"></textarea>
                            </div>
                            <div class="modal-footer">
                                <button type="submit" class="btn btn-primary">Submit</button>
                            </div>
                    ...
                    <div class="modal-body AppearanceData">
                        <form class="row g-3">
                            ...
                            <div class="col-md-6 col-sm-12 BtnContainer" style="width:50%;">
                                <button type="button" class="btn btn-primary appearenceInitiate">
                                    <span>
                                ...
                                <button type="button" class="btn btn-primary appearenceEnded">
                                    <span>
                                        <img src="<?= url('assets/home/images/Icon2.png') ?>" alt="">
                                    </span>
                                    <p>Appearance ended</p>
                                </button>
                                <button type="button" class="btn btn-primary contactInvitee">
                                    <span>
                                        <img src="<?= url('assets/home/images/Icon3.png') ?>" alt="">
                                    </span>
                                    <p>Contact invitee</p>
                                </button>
                                <button type="button" class="btn btn-primary contactAdmin">
                                    <span>
                        ...
                        <form class="row g-3" id="sentCountorOffer">
                            <div class="col-md-6 col-sm-12 SmallDataBlock">
                                ...
                                <div class="col-md-12 col-sm-12">
                                    ...
                                    <input type="text" placeholder="Enter amount" id="counter_offer"
                                        name="counter_offer">
        ...
        <div class="modal fade CustomModal" id="AppearanceModal2RejectModel" data-bs-backdrop="static"
            data-bs-keyboard="false" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <form class="row g-3" id="rejectOfferForm">
                            <div class="col-md-12 col-sm-12 SmallDataBlock">
                                <div class="col-md-12 col-sm-12">
                                    ...
                                    <textarea type="text" placeholder="Enter Comment" id="reject_comment"
                                        name="reject_comment"></textarea>
                                    <input type="hidden" id="reject_invi_id" name="reject_invi_id">
                                </div>
                                <button type="submit" class="btn btn-primary">Submit</button>
                            </div>
                        </form>
        ...
        <div class="modal fade CustomModal" id="AppearanceModal2AcceptModel" data-bs-backdrop="static"
            data-bs-keyboard="false" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body AppearanceData">
                        <form class="row g-3" id="acceptOfferForm">
                            <div class="col-md-12 col-sm-12 SmallDataBlock">
                                <div class="col-md-12 col-sm-12">
                                    <label class="form-label">Comment</label>
                                    <textarea type="text" placeholder="Enter Comment" id="accept_comment"
                                        name="accept_comment"></textarea>
                                    <input type="hidden" id="accept_invi_id" name="accept_invi_id">
                                </div>
                                <button type="submit" class="btn btn-primary">Submit</button>
                            </div>
                        </form>
        ...
        <div class="modal fade CustomModal" id="AppearanceModal2ContactInvitee" data-bs-backdrop="static"
            data-bs-keyboard="false" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Contact Invitee</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body AppearanceData">
                        <form class="row g-3" id="contact_invitee_form">
                            <div class="col-md-12 col-sm-12 SmallDataBlock">
                                <div class="col-md-12 col-sm-12">
                                    <label class="form-label">Message</label>
                                    <textarea type="text" placeholder="Enter Message" id="message_contact_invitee"
                                        name="message_contact_invitee"></textarea>
                                    <input type="hidden" id="contact_invitee_receiver_id"
                                        name="contact_invitee_receiver_id">
                                </div>
                                <button type="submit" class="btn btn-primary">Submit</button>
                            </div>
                        </form>
        ...
        <div class="modal fade CustomModal" id="AppearanceModal2ContactAdmin" data-bs-backdrop="static"
            data-bs-keyboard="false" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body AppearanceData">
                        <form class="row g-3" id="contact_admin_form">
                            <div class="col-md-12 col-sm-12 SmallDataBlock">
                                <div class="col-md-12 col-sm-12">
                                    <label class="form-label">Message</label>
                                    <textarea type="text" placeholder="Enter Message" id="message_contact_admin"
                                        name="message_contact_admin"></textarea>
                                </div>
                                <button type="submit" class="btn btn-primary">Submit</button>
                            </div>
                        </form>
    ...
    if (count(@$accept)) {
        foreach ($accept as $k => $v) {
            ...
            $eventInfo = DB::select("select * from events where id = '" . $v->event_id . "' LIMIT 1");
            $cate = DB::select("select * from event_category where id = '" . @$eventInfo[0]->category . "' LIMIT 1");
            $startDate = @$eventInfo[0]->start_date;
            $startTime = date('h:i A', strtotime(@$eventInfo[0]->start_time));
            $endTime = date('h:i A', strtotime(@$eventInfo[0]->end_time));
            $start_date = date('d-m-Y', strtotime($startDate));
            $start_time = $startTime . " to " . $endTime;
            if (@$appMng->full_access == 1) {
                $model = '
                            <a href="" data-bs-toggle="modal" data-bs-target="#AppearanceModal1" id="accepted_receiver_id" relid-receiver="' . @$v->receiver_id . '" class="appearenceInitiateClick" appId_1="' . @$v->invId . '">
            ...
            echo '
                        <div class="Card col-lg-3 col-md-3 col-sm-6" appId="' . @$v->invId . '">
                        <div class="CardInner">
                            <div class="Cover"></div>
...
if (count(@$complete)) {
    ...
    <div class="container-fluid m-0 Section Event" style="display: none;">
        ...
        <?php } ?>
        <!-- Send Invitation Modal -->
        <div class="modal fade CustomModal" id="AddAppearanceModalAgain" data-bs-backdrop="static"
            data-bs-keyboard="false" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-xl">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        <form class="row g-3" id="invisubmitform_1" method="post" enctype="multipart/form-data">
                            <div class="col-md-4 col-sm-12">
                                <label class="form-label">Select Event</label>
                                <select name="invi_event_name_1" id="invi_event_name_1" required>
...
if (count(@$upcomingEventList)) {
    foreach (@$upcomingEventList as $k => $v) {
        echo '<option value="' . @$v->id . '">' . @$v->event_name . '</option>';
                            ...
                            <div class="col-md-4 col-sm-12">
                                <label class="form-label">Select A&E Member</label>
                                <select name="invi_event_user_1" id="invi_event_user_1" required>
                                    <option disabled value="">Selct</option>
                                    <?php
if (count(@$athletic)) {
    foreach (@$athletic as $k => $v) {
        echo '<option value="' . @$v->id . '">' . @$v->first_name . ' ' . @$v->last_name . '</option>';
                            ...
                            <div class="col-md-4 col-sm-12">
                                <label class="form-label">Price</label>
                                <input type="text" placeholder="Enter price" name="invi_price_1" id="invi_price_1"
                                    required>
                            </div>
                            <div class="col-md-4 col-sm-12">
                                <label class="form-label">Start Time</label>
                                <input type="time" placeholder="Time" name="invi_start_time_1" id="invi_start_time_1"
                                    required>
                            </div>
                            <div class="col-md-4 col-sm-12">
                                <label class="form-label">End Time</label>
                                <input type="time" placeholder="Time" name="invi_end_time_1" id="invi_end_time_1"
                                    required>
                            </div>
                            <div class="col-md-12 col-sm-12">
                                <label class="form-label">Instructions</label>
                                <textarea type="text" placeholder="Description" name="invi_description_1"
                                    id="invi_description_1"></textarea>
                            </div>
                            <div class="modal-footer">
                                <button type="submit" class="btn btn-primary">Submit</button>
                            </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form class="row g-3" id="submitform" method="post" enctype="multipart/form-data">
                            ...
                            <div class="col-md-4 col-sm-12">
                                <label class="form-label">Location *</label>
                                <input type="text" placeholder="Enter location" name="event_address" id="event_address"
                                    required>
                                ...
                                <input type="hidden" placeholder="Near" name="userId" id="userId"
                                    value="<?= session()->get('USERLOGINID') ?>">
                            </div>
                            <div class="col-md-4 col-sm-12">
...
if (@$tags) {
    foreach (@$tags as $k => $v) {
        echo '<option value="' . @$v->id . '">' . @$v->name . '</option>';
                            ...
                            <div class="col-md-4 col-sm-12">
                                <label class="form-label">Start Time *</label>
                                <input type="time" placeholder="Start Time" name="event_start_time"
                                    id="event_start_time" required>
                            </div>
                            <div class="col-md-4 col-sm-12">
                                <label class="form-label">End Time *</label>
                                <input type="time" placeholder="End Time" name="event_end_time" id="event_end_time"
                                    required>
                            </div>
                            <div class="col-md-12 col-sm-12">
                                <label class="form-label">Description</label>
                                <textarea type="text" placeholder="Description" name="event_description"
                            ...
                            <div class="row m-0 pt-4 pb-2">
                                <div class="row m-0 InnerData g-3">
                                    ...
                                    <div class="col-md-4 col-sm-12">
                                        ...
                                        <input type="text" placeholder="Enter phone number" name="event_phone"
                                            id="event_phone" required>
                                    </div>
                                    <div class="col-md-4 col-sm-12">
                                        <label class="form-label">Email *</label>
                                        <input type="email" placeholder="Enter email address" name="event_email"
                                            id="event_email" required>
                                    </div>
                                    <div class="col-md-4 col-sm-12">
                                        <label class="form-label">Website</label>
                                        <input type="text" placeholder="Enter website URL" name="event_website"
                                            id="event_website">
                                    </div>
                                    <div class="col-md-4 col-sm-12">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form class="row g-3" id="edit_event_submitform" method="post" enctype="multipart/form-data">
                            <div class="col-md-4 col-sm-12">
                                <label class="form-label">Event Name *</label>
                                <input type="text" placeholder="Enter event name" name="edit_event_name"
                                    id="edit_event_name" required>
                            </div>
                            <div class="col-md-4 col-sm-12">
                                <label class="form-label">Location *</label>
                                <input type="text" placeholder="Enter location" name="edit_event_address"
                                    id="edit_event_address" required>
                                <input type="hidden" placeholder="Near" name="edit_event_latitude"
                                    id="edit_event_latitude">
                                <input type="hidden" placeholder="Near" name="edit_event_longitude"
                                    id="edit_event_longitude">
                                <input type="hidden" placeholder="Near" name="edit_event_country"
                                    id="edit_event_country">
                                ...
                                <input type="hidden" placeholder="Near" name="edit_event_zipcode"
                                    id="edit_event_zipcode">
...
if (@$tags) {
    foreach (@$tags as $k => $v) {
        echo '<option value="' . @$v->id . '">' . @$v->name . '</option>';
                            ...
                            <div class="col-md-4 col-sm-12">
                                <label class="form-label">Date *</label>
                                <input type="date" placeholder="Date" name="edit_event_date" id="edit_event_date"
                                    required>
                            </div>
                            <div class="col-md-4 col-sm-12">
                                <label class="form-label">Start Time *</label>
                                <input type="time" placeholder="Start Time" name="edit_event_start_time"
                                    id="edit_event_start_time" required>
                            </div>
                            <div class="col-md-4 col-sm-12">
                                <label class="form-label">End Time *</label>
                                <input type="time" placeholder="End Time" name="edit_event_end_time"
                                    id="edit_event_end_time" required>
                            </div>
                            <div class="col-md-12 col-sm-12">
                                <label class="form-label">Description</label>
                                <textarea type="text" placeholder="Description" name="edit_event_description"
                                    id="edit_event_description"></textarea>
                            </div>
                            <div class="row m-0 pt-3">
                                <div class="row m-0 InnerData g-3" style="padding: 10px;">
                                    <div class="col-md-4 col-sm-12 m-0">
        ...
        echo '<option value="' . @$v->id . '">' . @$v->name . '</option>';
                            ...
                            <div class="row m-0 pt-4 pb-2">
                                <div class="row m-0 InnerData g-3">
                                    ...
                                    <div class="col-md-4 col-sm-12">
                                        <label class="form-label">Phone *</label>
                                        <input type="text" placeholder="Enter phone number" name="edit_event_phone"
                                            id="edit_event_phone" required>
                                    </div>
                                    <div class="col-md-4 col-sm-12">
                                        <label class="form-label">Email *</label>
                                        <input type="email" placeholder="Enter email address" name="edit_event_email"
                                            id="edit_event_email" required>
                                    </div>
                                    <div class="col-md-4 col-sm-12">
                                        <label class="form-label">Website</label>
                                        <input type="text" placeholder="Enter website URL" name="edit_event_website"
                                            id="edit_event_website">
                                    </div>
                                    <div class="col-md-4 col-sm-12">
                                        <label class="form-label">Upload Images</label>
                                        <input type="file" class="form-control" id="edit_event_image"
                                            name="edit_event_image" autocomplete="off" multiple>
                                    </div>
                                </div>
                            </div>
                            <div class="modal-footer">
                        ...
                        <div class="row m-0 InvitedPeopleTab">
                            <div class="col-md-12 col-sm-12">
                                ...
                                <ul class="nav nav-tabs" id="myTab" role="tablist">
                                    <li class="nav-item" role="presentation" id="allInvitationTab">
                                        <button class="nav-link active" id="All-Tab" data-bs-toggle="tab"
                                            data-bs-target="#AllTab" type="button" role="tab" aria-controls="AllTab"
                                            aria-selected="true">All</button>
                                    </li>
                                    <li class="nav-item" role="presentation" id="invitedInvitationTab">
                                ...
                                <div class="tab-content">
                                    <input class="form-control mt-4 mb-4 SearchBarInner" type="search"
                                        placeholder="Search" aria-label="Search" id="searchInvitee">
            ...
            echo '
                    <div class="Card col-lg-3 col-md-3 col-sm-6">
                        ...
                        <div class="IconContainer" style="position: absolute; top: 10px; right: 30px;z-index: 999">
                            <a href="javascript:void(0);" class="bookmarkEvent" style=" width: 35px; height: 35px; display: flex; background: #fff; border-radius: 100px; align-items: center; justify-content: center;" id="bookmarkEvent_' . @$v->id . '" relid="' . @$v->id . '">
                                ' . @$fav . '
                            </a>
                        </div>
                    </div>';
    ...
    foreach (@$myeventList as $k => $v) {
        ...
        echo '
                                <div class="Card col-lg-3 col-md-3 col-sm-6">
                                    ...
                                    <div class="IconContainer" style="position: absolute; top: 10px; right: 30px;z-index: 999">
                                        <a href="javascript:void(0);" class="bookmarkEvent" style=" width: 35px; height: 35px; display: flex; background: #fff; border-radius: 100px; align-items: center; justify-content: center;" id="bookmarkEvent1_' . @$v->id . '" relid="' . @$v->id . '">
                                            ' . @$fav . '
                                        </a>' . $edit . ' ' . $delete . '
                                    </div>
                                </div>';
    ...
    foreach (@$favEvent as $k => $v) {
        ...
        echo '
                                <div class="Card col-lg-3 col-md-3 col-sm-6">
                                    ...
                                    <div class="IconContainer" style="position: absolute; top: 10px; right: 30px;z-index: 999">
                                        <a href="javascript:void(0);" class="bookmarkEvent" style=" width: 35px; height: 35px; display: flex; background: #fff; border-radius: 100px; align-items: center; justify-content: center;" id="allbookmarkEvent_' . @$v->id . '" relid="' . @$v->id . '">
                                            ' . @$fav . '
                                        </a>
                                    </div>
                                </div>';
        ...
        <div class="modal fade CustomModal" id="AddProductModel" data-bs-backdrop="static" data-bs-keyboard="false"
            ...
            <div class="modal-dialog modal-dialog-centered modal-xl">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form class="row g-3 AddProduct" id="addProductForm" method="post"
                            ...
                            <div class="col-md-4 col-sm-12">
                                <label class="form-label">Price *</label>
                                <input type="text" placeholder="Enter price" name="product_price" id="product_price"
                                    required>
                            </div>
                            <div class="col-md-4 col-sm-12">
                                <label class="form-label">Tags *</label>
...
if (@$tags) {
    foreach (@$tags as $k => $v) {
        echo '<option value="' . @$v->name . '">' . @$v->name . '</option>';
                            ...
                            <div class="col-md-12 col-sm-12">
                                <label class="form-label">Description</label>
                                <textarea type="text" placeholder="Description" name="product_description"
        ...
        <div class="modal fade CustomModal" id="AddServiceModel" data-bs-backdrop="static" data-bs-keyboard="false"
            ...
            <div class="modal-dialog modal-dialog-centered modal-xl">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form class="row g-3 AddService" id="addServiceForm" method="post"
                            enctype="multipart/form-data">
                            <div class="col-md-4 col-sm-12">
                                <label class="form-label">Choose Category *</label>
                            ...
                            <div class="col-md-4 col-sm-12">
                                <label class="form-label">Price *</label>
                                <input type="text" placeholder="Enter price" name="service_price" id="service_price"
                                    required>
                            </div>
                            <div class="col-md-4 col-sm-12">
                                <label class="form-label">Tags *</label>
                                <!--<input type="text" placeholder="#Tags" name="service_tags" id="service_tags">-->
                                <select name="service_tags[]" id="service_tags" multiple>
                                    <option disabled value="">Choose a Tags</option>
                                    <?php
if (@$tags) {
    foreach (@$tags as $k => $v) {
        echo '<option value="' . @$v->name . '">' . @$v->name . '</option>';
                            ...
                            <div class="col-md-4 col-sm-12">
                                ...
                                <input type="file" class="form-control" name="service_image" id="service_image"
                                    multiple>
                                <input type="hidden" class="form-control" id="service_listing_id"
                                    name="service_listing_id">
                            </div>
                            <div class="col-md-12 col-sm-12">
                                <label class="form-label">Description</label>
                                <textarea type="text" placeholder="Description" name="service_description"
        ...
        <div class="modal fade CustomModal" id="EditProductModal" data-bs-backdrop="static" data-bs-keyboard="false"
            ...
            <div class="modal-dialog modal-dialog-centered modal-xl">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form class="row g-3 AddProduct" id="editProductForm" method="post"
                            enctype="multipart/form-data">
                            <div class="col-md-4 col-sm-12">
                                <label class="form-label">Choose Category *</label>
...
if (@$product_category) {
    foreach (@$product_category as $k => $v) {
        echo '<option value="' . @$v->id . '">' . @$v->name . '</option>';
                            ...
                            <div class="col-md-4 col-sm-12">
                                <label class="form-label">Product Name *</label>
                                <input type="text" placeholder="Enter product name" name="edit_product_name"
                                    id="edit_product_name" required>
                            </div>
                            <div class="col-md-4 col-sm-12">
                                <label class="form-label">Price *</label>
                                <input type="text" placeholder="Enter price" name="edit_product_price"
                                    id="edit_product_price" required>
                            </div>
                            <div class="col-md-4 col-sm-12">
                                <label class="form-label">Tags *</label>
                                <!--<input type="text" placeholder="#Tags" name="edit_product_tags" id="edit_product_tags">-->
                                <select name="edit_product_tags[]" id="edit_product_tags" multiple>
                                    <option disabled value="">Choose a Tags</option>
                                    <?php
if (@$tags) {
    foreach (@$tags as $k => $v) {
        echo '<option value="' . @$v->name . '">' . @$v->name . '</option>';
                            ...
                            <div class="col-md-4 col-sm-12">
                                ...
                                <input type="file" class="form-control" id="edit_product_image"
                                    name="edit_product_image" multiple>
                                <input type="hidden" class="form-control" id="edit_product_listing_id"
                                    name="edit_product_listing_id">
                                <input type="hidden" class="form-control" id="edit_product_id" name="edit_product_id">
                            </div>
                            <div class="col-md-12 col-sm-12">
                                <label class="form-label">Description</label>
                                <textarea type="text" placeholder="Description" name="edit_product_description"
                                    id="edit_product_description"></textarea>
                            </div>
                            <div class="modal-footer">
                                <button type="submit" class="btn btn-primary">Save</button>
                            </div>
        ...
        <div class="modal fade CustomModal" id="editServiceModel" data-bs-backdrop="static" data-bs-keyboard="false"
            ...
            <div class="modal-dialog modal-dialog-centered modal-xl">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form class="row g-3 AddService" id="editServiceForm" method="post"
                            enctype="multipart/form-data">
                            <div class="col-md-4 col-sm-12">
                                <label class="form-label">Choose Category *</label>
...
if (@$product_category) {
    foreach (@$product_category as $k => $v) {
        echo '<option value="' . @$v->id . '">' . @$v->name . '</option>';
                            ...
                            <div class="col-md-4 col-sm-12">
                                <label class="form-label">Service Name *</label>
                                <input type="text" placeholder="Enter service name" name="edit_service_name"
                                    id="edit_service_name" required>
                            </div>
                            <div class="col-md-4 col-sm-12">
                                <label class="form-label">Price *</label>
                                <input type="text" placeholder="Enter price" name="edit_service_price"
                                    id="edit_service_price" required>
                            </div>
                            <div class="col-md-4 col-sm-12">
                                <label class="form-label">Tags *</label>
                                <!--<input type="text" placeholder="#Tags" name="edit_service_tags" id="edit_service_tags">-->
                                <select name="edit_service_tags[]" id="edit_service_tags" multiple>
                                    <option disabled value="">Choose a Tags</option>
                                    <?php
if (@$tags) {
    foreach (@$tags as $k => $v) {
        echo '<option value="' . @$v->name . '">' . @$v->name . '</option>';
                            ...
                            <div class="col-md-4 col-sm-12">
                                <label class="form-label">Upload Images</label>
                                <input type="file" class="form-control" name="edit_service_image"
                                    id="edit_service_image" multiple>
                                <input type="hidden" class="form-control" id="edit_service_listing_id"
                                    name="edit_service_listing_id">
                                <input type="hidden" class="form-control" id="edit_service_id" name="edit_service_id">
                            </div>
                            <div class="col-md-12 col-sm-12">
                                <label class="form-label">Description</label>
                                <textarea type="text" placeholder="Description" name="edit_service_description"
                                    id="edit_service_description"></textarea>
                            </div>
                            <div class="modal-footer">
                                <button type="submit" class="btn btn-primary">Save</button>
                            </div>
                    ...
                    <div class="modal-body">
                        <form class="row g-3" id="EditBusinesssubmitform" method="post" enctype="multipart/form-data">
                            <div class="col-md-4 col-sm-12">
                                ...
                                <input type="text" placeholder="Enter business name" name="edit_business_name"
                                    id="edit_business_name" required>
                            </div>
                            <div class="col-md-4 col-sm-12">
...
if (@$listing_category) {
    foreach (@$listing_category as $k => $v) {
        echo '<option value="' . @$v->id . '">' . @$v->name . '</option>';
                            ...
                            <div class="col-md-6 col-sm-12">
                                <label class="form-label">Location *</label>
                                <input type="text" placeholder="Enter location" name="edit_business_address"
                                    id="edit_business_address" required>
                                <input type="hidden" placeholder="Near" name="edit_business_latitude"
                                    id="edit_business_latitude">
                                <input type="hidden" placeholder="Near" name="edit_business_longitude"
                                    id="edit_business_longitude">
                                <input type="hidden" placeholder="Near" name="edit_business_country"
                                    id="edit_business_country">
                                <input type="hidden" placeholder="Near" name="edit_business_state"
                                    id="edit_business_state">
                                <input type="hidden" placeholder="Near" name="edit_business_city"
                                    id="edit_business_city">
                                <input type="hidden" placeholder="Near" name="edit_business_zipcode"
                                    id="edit_business_zipcode">
                            </div>
                            <div class="col-md-6 col-sm-12">
                                <label class="form-label">Tags </label>
                                <!--<input type="text" placeholder="Ex: #SmallBusiness, #ShopSmall" name="edit_business_tags" id="edit_business_tags">-->
                                <select name="edit_business_tags" id="edit_business_tags" multiple>
                                    <option disabled value="">Choose a Tags</option>
                                    <?php
if (@$tags) {
    foreach (@$tags as $k => $v) {
        echo '<option value="' . @$v->name . '">' . @$v->name . '</option>';
                            ...
                            <div class="col-md-12 col-sm-12">
                                <label class="form-label">Description</label>
                                <textarea type="text" placeholder="Description" name="edit_business_description"
                                    id="edit_business_description"></textarea>
                            </div>
                            <div class="row m-0 pt-4 pb-2">
                                <div class="row m-0 InnerData g-3">
                                    ...
                                    <div class="col-md-4 col-sm-12">
                                        <label class="form-label">Phone *</label>
                                        <input type="text" placeholder="Enter phone number" name="edit_business_phone"
                                            id="edit_business_phone" required>
                                    </div>
                                    <div class="col-md-4 col-sm-12">
                                        <label class="form-label">Email *</label>
                                        <input type="email" placeholder="Enter email address" name="edit_business_email"
                                            id="edit_business_email" required>
                                    </div>
                                    <div class="col-md-4 col-sm-12">
                                        <label class="form-label">Website</label>
                                        <input type="text" placeholder="Enter website URL" name="edit_business_website"
                                            id="edit_business_website">
                                    </div>
                                    <div class="col-md-4 col-sm-12">
                                        <label class="form-label">Upload Images</label>
                                        <input type="file" class="form-control" id="edit_business_image"
                                            name="edit_business_image" autocomplete="off" multiple>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form class="row g-3" id="Businesssubmitform" method="post" enctype="multipart/form-data">
                            ...
                            <div class="col-md-6 col-sm-12">
                                <label class="form-label">Location *</label>
                                <input type="text" placeholder="Enter location" name="business_address"
                                    id="business_address" required>
                                <input type="hidden" placeholder="Near" name="business_latitude" id="business_latitude">
                                <input type="hidden" placeholder="Near" name="business_longitude"
                                ...
                                <input type="hidden" placeholder="Near" name="business_userId" id="business_userId"
                                    value="<?= session()->get('USERLOGINID') ?>">
                            </div>
                            <div class="col-md-6 col-sm-12">
                                <label class="form-label">Tags </label>
                                <!--<input type="text" placeholder="Ex: #SmallBusiness, #ShopSmall" name="business_tags" id="business_tags">-->
                                <select name="business_tags" id="business_tags" multiple>
                                    <option disabled value="">Choose a Tags</option>
                                    <?php
if (@$tags) {
    foreach (@$tags as $k => $v) {
        echo '<option value="' . @$v->name . '">' . @$v->name . '</option>';
                            ...
                            <div class="col-md-12 col-sm-12">
                                <label class="form-label">Description</label>
                                <textarea type="text" placeholder="Description" name="business_description"
                            ...
                            <div class="row m-0 pt-4 pb-2">
                                <div class="row m-0 InnerData g-3">
                                    ...
                                    <div class="col-md-4 col-sm-12">
                                        <label class="form-label">Phone *</label>
                                        <input type="text" placeholder="Enter phone number" name="business_phone"
                                            id="business_phone" required>
                                    </div>
                                    <div class="col-md-4 col-sm-12">
                                        <label class="form-label">Email *</label>
                                        <input type="email" placeholder="Enter email address" name="business_email"
                                            id="business_email" required>
                                    </div>
                                    <div class="col-md-4 col-sm-12">
                                        <label class="form-label">Website</label>
                                        <input type="text" placeholder="Enter website URL" name="business_website"
                                            id="business_website">
                                    </div>
                                    <div class="col-md-4 col-sm-12">
                                        <label class="form-label">Upload Images</label>
                                        <input type="file" class="form-control" id="business_image"
                                            name="business_image" autocomplete="off" multiple>
                                    </div>
                                </div>
                            </div>
                            <div class="modal-footer">
                                <div class="BusinessAddFooter" style="display: flex;">
                                    <div class="AddProduct">
                                        <input type="checkbox" style="width:3%;" name="add_product_or_not"
                                            id="add_product_or_not">
            ...
            <div class="modal-dialog modal-dialog-centered modal-xl">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <div style="margin-left: 43rem;display:none;" id="productButton">
                            <button type="button" id="addProductUnderBusiness"
                                style="border: 1px solid #b58b42;border-radius: 5px;font-size: 14px;background: #fff;color: #c5a668;padding: 8px;font-weight: 700;">Add
                                Product</button>
                            <button type="button" id="addServiceUnderBusiness"
                                style="border: 1px solid #b58b42;border-radius: 5px;font-size: 14px;background: #fff;color: #c5a668;padding: 8px;font-weight: 700;">Add
                                Service</button>
                        </div>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        ...
        <div id="MyAllBusiness" class="row m-0 TabContent active">
            <input type="hidden" name="total_count" id="total_count"
                value="<?php    echo !empty($allBusinessCount) ? $allBusinessCount : ''; ?>" />
            <?php
    if (@$allBusiness) {
        foreach (@$allBusiness as $k => $v) {
            ...
            echo '
						<div class="Card col-lg-3 col-md-3 col-sm-6 post-item" relid-1="' . @$v->id . '">
						  <div class="CardInner business-detail-1"   style="background:url(' . @$galleryImg . ') no-repeat center center / cover;" relid="' . @$v->id . '" data-bs-toggle="modal" data-bs-target="#DetailsMyBusinessModal" hide-edit-delete="on">
							<div class="Cover" ></div>
							<img class="UserImage"
							  src="' . @$userProfile . '"
							  alt="">
...
if (@$myBusiness) {
    foreach (@$myBusiness as $k => $v) {
        ...
        echo '
						<div class="Card col-lg-3 col-md-3 col-sm-6">
						  <div class="CardInner business-detail-1"   style="background:url(' . @$galleryImg . ') no-repeat center center / cover;" relid="' . @$v->id . '" data-bs-toggle="modal" data-bs-target="#DetailsMyBusinessModal" my-business="on">
							<div class="Cover" ></div>
							<img class="UserImage"
							  src="' . @$userProfile . '"
							  alt="">
...
if (@$favBusiness) {
    ...
    <div class="container-fluid m-0 Section Subscription" style="display: none;">
        ...
        <button type="button" class="AddButton get-payment-list" relid="<?= session()->get('USERLOGINID') ?>"
            data-bs-toggle="modal" data-bs-target="#SubscriptionHistoryModal">
...
if (count(@$plan)) {
    ...
    foreach (@$plan as $k => $v) {
        ...
        foreach ($nav as $k1 => $v1) {
            $out .= '<li>' . @$v1 . '</li>';
            $learnMore .= '<div class="col-lg-12 col-md-12 p-0"> <div class="TransactionBlock"> <div class="TransactionData"> <img src="' . url('assets/home/images/CompleteIcon.png') . '" alt=""> <p class="m-0 TransactionTextdata">Lorem ipsum dolor sit amet, consectetur adipisicing elit.</p> </div> <div class="TransactionAmount"> <p class="m-0">Yes</p> </div> </div> </div>';
        }
        ...
        if (!empty(@$usersubInfo)) {
            if ($usersubInfo->sub_id == @$v->id) {
                if (@$usersubInfo->expiry_date >= date('Y-m-d')) {
                    $status = 'Activated';
                    //$sub = '<a href="'.url('subscription/payment?amt='.@$v->amount.'&subId='.@$v->id.'').'" class="SubscriptionBtn"><p>Choose ('.@$status.')</p></a>';
                    $sub = '<a href="javasctipt:void(0)" class="SubscriptionBtn"><p>' . @$status . '</p></a>';
                } elseif (@$usersubInfo->expiry_date < date('Y-m-d')) {
                    $status = 'Expired';
                    $sub = '<a href="javascript:void(0)" class="SubscriptionBtn"><p>' . @$status . '</p></a>';
                }
            } else {
                $status = '';
                $sub = '<a href="' . url('subscription/payment?amt=' . @$v->amount . '&subId=' . @$v->id . '') . '" class="SubscriptionBtn"><p>Choose</p></a>';
            }
        } else {
            $status = '';
            $sub = '<a href="' . url('subscription/payment?amt=' . @$v->amount . '&subId=' . @$v->id . '') . '" class="SubscriptionBtn"><p>Choose</p></a>';
                ...
                <div class="col-lg-3 col-md-3">
                    <div class="SubscriptionBlock">
                        ...
                        <ul style="margin: 0px;"><?= @$out; ?></ul>
                        <div class="col-lg-12 mb-3"
                            style="border-radius: 30px;box-shadow: -5px 5px 10px #c5c5c5;position: relative;padding: 15px;border: 1px solid #e9e9e9;text-align: justify;">
                            <ul id="menu-list" style="list-style: circle;">
                                <?php
        $access = [];
        if ($v->access) {
            $exAccess = explode(',', $v->access);
            foreach ($exAccess as $k => $v) {
                $access[] = $v;
            }
        }
        $menus = DB::table('sub_access_menu')->where(['status' => 1])->select('*')->get();
        if (!empty($menus)) {
            $i = 1;
            foreach ($menus as $key => $row) {
                                        ?>
                                <li data-menu-id="<?=$row->id?>">
                                    <?php
                $check = DB::table('sub_permision_menu')->where(['sub_id' => $v->id, 'menu_id' => $row->id])->select('*')->first();
                if (@$check->read_access == 1 || @$check->write_access == 1 || @$check->full_access == 1) {
                    $percolumn = 'checked';
                } else {
                    $percolumn = '';
                }
                if (@$check->number_of > 0) {
                    $number_of = @$check->number_of;
                } else {
                    $number_of = '0';
                }
                if (@$row->menu) {
                    echo '<p style="margin: 0px !important">' . $row->menu . ' access count is ' . @$number_of . '</p>';
                } else {
                    echo '<p style="margin: 0px !important">' . '&#8212' . '0</p>';
                }
                                        ?>
                                </li>
                                <?php            }
                        ...
                        <div class="m-0 row w-100 LearnMoreData" data-content="' . @$i . '"><?= @$learnMore; ?></div>
                        <div class="SubscriptionBtnContainer"><?= @$sub; ?></div>
                    </div>
                </div>
                <?php        $i++;
    }
...
<style>
    .Section.Subscription .SubscriptionBlock ul li {
        font-size: 12px !important;
    }
</style>
<!--<script src='https://cdnjs.cloudflare.com/ajax/libs/jquery/2.1.3/jquery.min.js'></script>-->
<script
    src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCtg6oeRPEkRL9_CE-us3QdvXjupbgG14A&libraries=places"></script>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $(".edit-info").click(function () {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    $('#edit_age').chosen('destroy').val(response.age_range).chosen();
                    //$('#edit_age option:selected').val(["2", "3"]);
                    if (response.image) {
                        $('#edit_image').attr('src', 'ads/' + response.image).show();
                    } else {
                        $('#edit_image').hide();
                    }
                }
        ...
        $('#business_tags').chosen({ max_selected_options: 10, width: '100%' });
        $('#edit_business_tags').chosen({ max_selected_options: 10, width: '100%' });
        $('#product_tags').chosen({ max_selected_options: 10, width: '100%' });
        $('#service_tags').chosen({ max_selected_options: 10, width: '100%' });
        $('#edit_product_tags').chosen({ max_selected_options: 10, width: '100%' });
        $('#edit_service_tags').chosen({ max_selected_options: 10, width: '100%' });
        $(".edit-event-detail").click(function () {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    $('#edit_event_start_time').val(response.start_time);
                    $('#edit_event_end_time').val(response.end_time);
    ...
    $(document).ready(function () {
        $("#edit_event_submitform").on('submit', function (e) {
            ...
            var edit_event_start_time = $('#edit_event_start_time').val();
            var edit_event_end_time = $('#edit_event_end_time').val();
            ...
            form_data.append("event_longitude", event_longitude);
            form_data.append("event_date", event_date);
            form_data.append("edit_event_start_time", edit_event_start_time);
            form_data.append("edit_event_end_time", edit_event_end_time);
            form_data.append("event_tags", event_tags);
            form_data.append("event_phone", event_phone);
            form_data.append("event_email", event_email);
            form_data.append("event_website", event_website);
        ...
        $.ajax({
            ...
            success: function (response) {
                if (response.status == 1) {
                    ...
                    $('#bookmarkEvent1_' + eventId + '').html('<i class="fa fa-heart" aria-hidden="true"></i>');
                    ...
                    $('#bookmarkEvent1_' + eventId + '').html('<i class="fa fa-heart-o" aria-hidden="true"></i>');
    ...
    $(document).ready(function () {
        ...
        $(document.body).on('click', '.business-detail', function () {
            var businessId = $(this).attr('relid');
            $.ajax({
        ...
        $(document.body).on('click', '.business-detail-1', function () {
            var businessId = $(this).attr('relid');
            var my_business = $(this).attr('my-business');
            var hide_edit = $(this).attr('hide-edit-delete');
            $.ajax({
                url: "<?= url('dashboard/get_business_detail') ?>",
                method: "POST",
                data: { businessId: businessId, hide_edit: hide_edit, "_token": "{{ csrf_token() }}" },
                dataType: 'text',
                success: function (response) {
                    $('.business-block-detail').html(response);
                    if (my_business == 'on') {
                        $("#productButton").css('display', 'block');
                        $('#addProductUnderBusiness').attr('new-businessId', businessId);
                        $('#addServiceUnderBusiness').attr('new-businessId', businessId);
                    }
                }
            });
        });
        $("#addProductUnderBusiness").click(function () {
            var businessId = $(this).attr('new-businessId');
            $('#listing_id').val(businessId);
            $("#DetailsMyBusinessModal").modal("hide");
        ...
        $("#addServiceUnderBusiness").click(function () {
            var businessId = $(this).attr('new-businessId');
            $('#service_listing_id').val(businessId);
            $("#DetailsMyBusinessModal").modal("hide");
        ...
        $(".edit-business-detail").click(function () {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    $('#edit_business_category').val(response.category);
                    $('#edit_business_tags').chosen('destroy').val(response.tags).chosen();
                }
            });
        });
    ...
    $("#editProductForm").on('submit', function (e) {
        ...
        var listing_id = $('#edit_product_listing_id').val();
    ...
    $(document).ready(function () {
        ...
        $("#invisubmitform_1").on('submit', function (e) {
            e.preventDefault();
            var form_data = new FormData();
            var invi_event_name = $('#invi_event_name_1').val();
            var invi_event_user = $('#invi_event_user_1').val();
            var invi_price = $('#invi_price_1').val();
            var invi_start_time = $('#invi_start_time_1').val();
            var invi_end_time = $('#invi_end_time_1').val();
            var invi_description = $('#invi_description_1').val();
            form_data.append("invi_event_name", invi_event_name);
            form_data.append("invi_event_user", invi_event_user);
            form_data.append("invi_price", invi_price);
            form_data.append("invi_start_time", invi_start_time);
        ...
        $(".accept-offer").click(function () {
            var invi_id = $('#invi_id').val();
            //console.log(invi_id);
            $('#AppearanceModal2').modal('hide');
            $('#AppearanceModal2AcceptModel').modal('show');
            $('#accept_invi_id').val(invi_id);
        /*$.ajax({
    ...
    $(".contactInvitee").click(function () {
        var relid_receiver = $('#accepted_receiver_id').attr('relid-receiver');
        $('#AppearanceModal1').modal('hide');
        $('#AppearanceModal2ContactInvitee').modal('show');
        $('#contact_invitee_receiver_id').val(relid_receiver);
    });
    $(".contactAdmin").click(function () {
        $('#AppearanceModal1').modal('hide');
        $('#AppearanceModal2ContactAdmin').modal('show');
    });
    $("#contact_invitee_form").on('submit', function (e) {
        e.preventDefault();
        var form_data = new FormData();
        var contact_invitee_receiver_id = $('#contact_invitee_receiver_id').val();
        var message_contact_invitee = $('#message_contact_invitee').val();
        form_data.append("contact_invitee_receiver_id", contact_invitee_receiver_id);
        form_data.append("message_contact_invitee", message_contact_invitee);
        $.ajax({
            headers: {
                'X-CSRF-TOKEN': "{{ csrf_token() }}"
            },
            type: 'POST',
            url: '<?php echo url('dashboard/contact_invitee'); ?>',
            data: form_data,
            dataType: "json",
            contentType: false,
            cache: false,
    ...
    $("#contact_admin_form").on('submit', function (e) {
        e.preventDefault();
        var form_data = new FormData();
        var message_contact_admin = $('#message_contact_admin').val();
        form_data.append("message_contact_admin", message_contact_admin);
        $.ajax({
            headers: {
                'X-CSRF-TOKEN': "{{ csrf_token() }}"
            },
            type: 'POST',
            url: '<?php echo url('dashboard/contact_admin'); ?>',
            data: form_data,
            dataType: "json",
            contentType: false,
            cache: false,
    ...
    $(".appearenceInitiateClick").click(function () {
        var appId_1 = $(this).attr('appId_1');
        $('.appearenceInitiate').attr('appearenceInitiateId', appId_1);
        $('.appearenceEnded').attr('appearenceEndedId', appId_1);
    });
    $(document.body).on('click', ".appearenceEnded", function () {
        var inviId = $(this).attr('appearenceEndedId');
        //var quantity = $('#counterId').text();
        swal({
            title: 'Do you really want your appearence ended?',
            type: 'warning',
            showCancelButton: true,
            confirmButtonColor: '#A5DC86',
            cancelButtonColor: '#DD6B55',
            ...
            if (isConfirm) {
                $.ajax({
                    url: "<?= url('dashboard/appearence_ended') ?>",
                    method: "POST",
                    data: { invitationId: inviId, "_token": "{{ csrf_token() }}" },
                    dataType: 'json',
                    success: function (data) {
                        //console.log(data);
                        if (data.status == 1) {
    ...
    $(document.body).on('click', ".appearenceInitiate", function () {
        var inviId = $(this).attr('appearenceInitiateId');
        //var quantity = $('#counterId').text();
        swal({
            title: 'Do you really want your appearence start?',
            type: 'warning',
            showCancelButton: true,
            confirmButtonColor: '#A5DC86',
            cancelButtonColor: '#DD6B55',
            ...
            if (isConfirm) {
                $.ajax({
                    url: "<?= url('dashboard/appearence_start') ?>",
                    method: "POST",
                    data: { invitationId: inviId, "_token": "{{ csrf_token() }}" },
                    dataType: 'json',
                    success: function (data) {
    ...
    $("#acceptOfferForm").on('submit', function (e) {
        e.preventDefault();
        var form_data = new FormData();
        var accept_comment = $('#accept_comment').val();
        var invi_id = $('#accept_invi_id').val();
        form_data.append("accept_comment", accept_comment);
        form_data.append("invi_id", invi_id);
        $.ajax({
            headers: {
                'X-CSRF-TOKEN': "{{ csrf_token() }}"
            ...
            type: 'POST',
            url: '<?php echo url('dashboard/accept_invitation'); ?>',
            data: form_data,
            dataType: "json",
            contentType: false,
            cache: false,
    ...
    $("#rejectOfferForm").on('submit', function (e) {
        ...
        var invi_id = $('#reject_invi_id').val();
        form_data.append("reject_comment", reject_comment);
        form_data.append("invi_id", invi_id);
        $.ajax({
            headers: {
                'X-CSRF-TOKEN': "{{ csrf_token() }}"
            ...
            type: 'POST',
            url: '<?php echo url('dashboard/reject_invitation'); ?>',
            data: form_data,
            dataType: "json",
            contentType: false,
            cache: false,
    ...
    $(document.body).on('click', '.product-details', function () {
        ...
        var hide_button = $(this).attr('hide-edit-delete-product');
        $.ajax({
            url: "<?= url('dashboard/get_product_details') ?>",
            method: "POST",
            data: { productId: productId, hide_button: hide_button, "_token": "{{ csrf_token() }}" },
            dataType: 'text',
            success: function (response) {
    ...
    $(document.body).on('click', '.service-details', function () {
        ...
        var hide_button = $(this).attr('hide-edit-delete-service');
        $.ajax({
            url: "<?= url('dashboard/get_service_details') ?>",
            method: "POST",
            data: { serviceId: serviceId, hide_button: hide_button, "_token": "{{ csrf_token() }}" },
            dataType: 'text',
            success: function (response) {
    ...
    $(document.body).on('click', '.edit-services', function () {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                $('#edit_service_tags').chosen('destroy').val(response.tags).chosen();
            }
        });
    });
    $(document.body).on('click', '.edit-product', function () {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                $('#edit_product_tags').chosen('destroy').val(response.tags).chosen();
            }
        });
    });
...
<script>
    ...
    $(document.body).on('click', ".sendInvitationAgain", function () {
        var userId = $(this).attr('relid');
        $("#AddAppearanceModalAgain").modal('show');
        $("#EventInvitedModal").modal('hide');
        $('#invi_event_user_1').val(userId);
        //$('#AddAppearanceModal').css('display', 'block');
    });
    $(document.body).on('click', "#allInvitationTab", function () {
        $('.allInvitedBlock').css('display', 'block');
        $('.InvitedBlock').css('display', 'none');
    });
    $(document.body).on('click', "#invitedInvitationTab", function () {
        $('.allInvitedBlock').css('display', 'none');
        $('.InvitedBlock').css('display', 'block');
    });
    ...
    $(document).ready(function () {
        ...
        $("#invi_event_name").change(function () {
            $.ajax({
                type: "POST",
                url: "<?= url('dashboard/get_event_edit_detail') ?>",
                data: { eventId: $(this).val(), "_token": "{{ csrf_token() }}" },
                dataType: 'json',
                success: function (data) {
                    // $("#suggesstion-box").show();
                    // $("#suggesstion-box").html(data);
                    // //$("#search-box").css("background", "#FFF");
                    //$('#edit_event_tags').chosen('destroy').val(response.tags).chosen();
                    $('#invi_start_time').val(data.start_time);
                    $('#invi_end_time').val(data.end_time);
                }
            });
        });
    });
    ...
    $(document).ready(function () { $('#edit_age').chosen({ max_selected_options: 10, width: '100%' }); $('#sel2').chosen({ width: '200px' }); $('#sel3').chosen({ no_results_text: "Not found", width: '200px' }); $('#age').chosen({ max_selected_options: 10, width: '100%' }); $('#sel5').chosen({ allow_single_deselect: true, width: '200px' }); });
</script>
</body>
