  ...
  <header>
    ...
    <main role="main" class="Main">
     ...
     <div class="container-fluid m-0 Section ReferralLink" style="display: block;">
        ...
        <div class="modal-dialog modal-dialog-centered modal-xl">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="row g-3" id="invitesubmitform" method="post" enctype="multipart/form-data">
                ...
                <div class="col-md-4 col-sm-12">
                  ...
                  <input type="text" placeholder="Whom are you referring" name="name" id="name" required>
                </div>
                ...
                <div class="col-md-4 col-sm-12">
                  ...
                  <input type="text" placeholder="Enter Referral Code" name="refer_code" id="refer_code" required>
                </div>
      ...
      <div class="row m-0 TabBar mb-2">
        ...
        <div class="row m-0 align-items-center d-flex flex-row justify-content-center" style="background: #fff;">
          <div class="col-lg-3 col-md-3 col-sm-12 ReferralDataContainer">
            <p class="m-0 Heading">Total Rewards Earned</p>
				...
				foreach(@$myReferral as $k => $v){
					...
					echo '
						<div class="col-lg-3 col-md-3  mb-4">
							<div class="ReferralBlock" style="width: 100%;">
      ...
      <div id="MyRewards" class="row m-0 TabContent">
          ...
          <div class="TransactionBlock">
            <div class="TransactionData">
              ...
              <div class="TransactionTextdata">
                <p class="m-0">Referral Code #1234</p>
                <p class="m-0">Date</p>
        ...
        <div class="col-lg-4 col-md-4 ps-0">
          <div class="TransactionBlock">
            <div class="TransactionData">
              <img src="<?=url('assets/home/images/InCompleteIcon.png')?>" alt="">
              <div class="TransactionTextdata">
                <p class="m-0">Referral Code #1234</p>
                <p class="m-0">Date</p>
									    ...
									    <?php
										    if(count(@$myReward)){
												foreach(@$myReward as $k => $v){
													...
													$userInfo = DB::table('users')->where(['id' => @$v->referral_user_id])->select('*')->first();
													$username = '';
													$active_date = '';
													if(@$userInfo){
														if(@$userInfo->first_name || @$userInfo->last_name){
														...
														if(!empty(@$userInfo->created_at) && @$userInfo->created_at != '0000-00-00 00:00:00'){
															$active_date = date('M d, Y', strtotime(@$userInfo->created_at));
														}
													}
													
													$referral_code = '--';
													if(!empty($v->referral_code)){
														$referral_code = $v->referral_code;
													}
													
													$referral_earned_point = '--';
													if(!empty($v->referral_earned_point)){
														$referral_earned_point = $v->referral_earned_point;
													}
													...
													echo '
														<tr>
															...
															<td class="hidden-xs">'.@$referral_code.'</td>
															<td class="hidden-xs">'.@$active_date.'</td>
															<td class="hidden-xs">'.@$referral_earned_point.'</td>
															<td class="hidden-xs"></td>
															<td class="hidden-xs">'.@$my_earned_point.'</td>
														</tr>
													';
												}
											}
					...
					foreach($pendingReferral as $k => $v){
						echo '
							<div class="col-lg-4 col-md-4 ps-0">
							  <div class="TransactionBlock">
								<div class="TransactionData">
								  <img src="'.url('https://techb.igiapp.com/starbiz/profile/2067166925.png').'" alt="" style="width: 60px;height: 60px;object-fit: cover;border-radius: 100%;">
								  <div class="TransactionTextdata">
									<p class="m-0">'.@$v->reffer_user_name.'</p>
									<p class="m-0">Referral Code : '.@$v->reffer_code.'</p>
									<p class="m-0 Pending">Pending</p>
								  </div>
								</div>
								<a href="javascript:void(0); "class="TransactionAmount resent" relid="'.@$v->id.'" style="color: #c5a668;">Resend</a>
							  </div>
							</div>
						';
					}
...
$(document).ready(function(){
	...
	$("#invitesubmitform").on('submit', function(e){
		e.preventDefault();	
		var form_data = new FormData();
		...
		$.ajax({
			...
			type: 'POST',
			url: '<?php echo url('dashboard/referInvite'); ?>',
			data: form_data,
			dataType:"json",
			contentType: false,
			cache: false,
