     ...
     <div class="container-fluid m-0 Section Network" >
      <div class="row m-0 TabBar">
        <div class="Pagination">
          <a href="<?=url('dashboard')?>" id="Home1"><i class="fa fa-angle-left" aria-hidden="true"></i> Home / Network Management</a>
        </div>
      ...
      <div id="AllMembers" class="row m-0 TabContent active">
	    <input type="hidden" name="total_count" id="total_count" value="<?php echo !empty($countCreator) ? $countCreator : ''; ?>" />
	    <?php
		    if(count(@$allMem) > 0){
