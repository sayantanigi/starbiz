...
<head>
    ...
    <style>
        .PaymentDetails { margin-top: 70px; }
        .PaymentDetails .TopSection { display: flex; flex-direction: column; align-items: center; justify-content: center; background: #c5a668; gap: 5px; padding-top: 15px; padding-bottom: 15px; border-top-left-radius: 15px; border-top-right-radius: 15px; z-index: 10; }
        .PaymentDetails .TopSection h1 { font-size: 30px; font-weight: 600; color: #fbfbfb; margin: 0; }
        .PaymentDetails .TopSection p { font-size: 16px; margin: 0; color: #fff; opacity: 0.8; }
        .PaymentDetails .BottomSection { padding-top: 15px; padding-bottom: 15px; background: #ffffff; box-shadow: 0 0 10px #ddd; border-bottom-left-radius: 15px; border-bottom-right-radius: 15px; }
        .PaymentDetails .BottomSection .Block { margin-bottom: 15px; }
        .PaymentDetails .BottomSection .Block label { display: block; text-align: left; font-size: 14px; margin-bottom: 5px; color: #000000; font-weight: 600; }
        .PaymentDetails .BottomSection .Block input { font-size: 16px; border: 1px solid #ddd; border-radius: 10px; outline: none; background-color: #f5f5f5; width: 100%; height: 40px; padding-left: 15px; padding-right: 15px; }
        .PaymentDetails .BottomSection .PayNowBtnBlock { align-items: center; justify-content: center; display: flex; }
        .PaymentDetails .BottomSection .PayNowBtn { height: 40px; background: #c5a668; display: flex; border-radius: 10px; z-index: 100; flex-direction: row; align-items: center; justify-content: center; gap: 15px; border: none; padding-left: 15px; padding-right: 15px; font-size: 15px; font-weight: 600; color: #fff; }
        .PaymentDetails .BottomSection .PayNowBtn:hover { background: linear-gradient(90deg, #b58b42, #7a5a28); }
        #paymentResponse>p {color: red !important;}
        @media only screen and (max-width: 480px) {
            .PaymentDetails {margin-top: 0;}
            .PaymentDetails .TopSection {border-top-left-radius: 0;border-top-right-radius: 0;}
            .PaymentDetails .BottomSection {border-bottom-left-radius: 0;border-bottom-right-radius: 0;}
        }
    </style>
</head>
        ...
        <div class="container PaymentDetails">
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 BottomSection">
                    <form action="{{url('webview/proceed_from_cart_web_view_stripe_payment')}}" method="POST" id="paymentFrm">
                        @csrf
                        <div class="row">
