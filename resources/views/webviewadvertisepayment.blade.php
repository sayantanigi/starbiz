                                            ...
                                            <div class="panel-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <form action="{{url('webview/submit_advertisement_payment')}}"
                                                            method="POST" id="paymentFrm">
                                                            @csrf
                                                            <div class="row">
                                                                <div class="col-xs-12">
                                                                    <div class="form-group">
                                                                        <label class="fw-semibold">NAME OF CARD
                                                                            HOLDER</label>
                                                                        ...
                                                                        <input type="hidden" name="sub_name"
                                                                            id="sub_name" value="<?=@$planInfo->name?>">
                                                                        <input type="hidden" name="email" id="email"
                                                                            value="<?=@$userInfo->email?>">
                                                                        <input type="hidden" name="adsId" id="adsId"
                                                                            value="<?=@$adsId?>">
                                                                        <input type="hidden" name="preferredListing"
                                                                            id="preferredListing"
                                                                            value="<?=@$preferredListing?>">
                                                                        <input type="hidden" name="duration"
                                                                            id="duration" value="<?=@$duration?>">

                                                                        <input type="hidden" name="network_user_id"
                                                                            id="network_user_id"
                                                                            value="<?=@$networkUserId?>">
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-xs-12">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" class="form-control"
                                                                            name="card_address" id="card_address"
                                                            ...
                                                            <div class="row">
                                                                <div class="col-xs-4 col-md-4">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" class="form-control"
                                                                            placeholder="Country" name="card_country"
                                                                            id="card_country"
                                                                ...
                                                                <div class="col-xs-4 col-md-4 pull-right">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" class="form-control"
                                                                            ...
                                                                            id="card_city" value="<?=@$userInfo->city?>"
                                                                            required>
                                                                    </div>
                                                                </div>
                                                            </div><br>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-xs-12">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" class="form-control"
                                                                            placeholder="Zipcode" name="card_zipcode"
                                                                            id="card_zipcode"
                                                                            value="<?=@$userInfo->zipcode?>" required>
                                                                    </div>
                                                                </div>
                                                            </div><br>
